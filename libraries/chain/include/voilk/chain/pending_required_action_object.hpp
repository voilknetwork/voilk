...
using voilk::protocol::required_automated_action;
...
FC_REFLECT( voilk::chain::pending_required_action_object,
            (id)(action) )
CHAINBASE_SET_INDEX_TYPE( voilk::chain::pending_required_action_object, voilk::chain::pending_required_action_index )
