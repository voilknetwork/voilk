...
namespace voilk { namespace chain {
   ...
   /**
    *  This object is used to track pending requests to convert vsd to voilk
    */
    ...
    *  1000 VOILK or 1000 * virtual_supply / (100*blocks_per_year) aka 10 * virtual_supply / blocks_per_year
    *
   ...
   class liquidity_reward_balance_object : public object< liquidity_reward_balance_object_type, liquidity_reward_balance_object >
   {
      public:
         ...
         int64_t           voilk_volume = 0;
         int64_t           vsd_volume = 0;
         uint128_t         weight = 0;
         ...
         {
            return voilk_volume * vsd_volume * is_positive();
         }

         uint128_t min_volume_weight()const
         {
            return std::min(voilk_volume,vsd_volume) * is_positive();
         }
         ...
         {
            return ( voilk_volume > 0 && vsd_volume > 0 ) ? 1 : 0;
         }
   };
   ...
   /**
    * @breif a route to send withdrawn coining shares.
    */
   class withdraw_coining_route_object : public object< withdraw_coining_route_object_type, withdraw_coining_route_object >
   {
      public:
         template< typename Constructor, typename Allocator >
         withdraw_coining_route_object( Constructor&& c, allocator< Allocator > a )
         {
            c( *this );
         }

         withdraw_coining_route_object(){}
   ...
   typedef multi_index_container<
      withdraw_coining_route_object,
      indexed_by<
         ordered_unique< tag< by_id >, member< withdraw_coining_route_object, withdraw_coining_route_id_type, &withdraw_coining_route_object::id > >,
         ordered_unique< tag< by_withdraw_route >,
            composite_key< withdraw_coining_route_object,
               member< withdraw_coining_route_object, account_name_type, &withdraw_coining_route_object::from_account >,
               member< withdraw_coining_route_object, account_name_type, &withdraw_coining_route_object::to_account >
            >,
         ...
         ordered_unique< tag< by_destination >,
            composite_key< withdraw_coining_route_object,
               member< withdraw_coining_route_object, account_name_type, &withdraw_coining_route_object::to_account >,
               member< withdraw_coining_route_object, withdraw_coining_route_id_type, &withdraw_coining_route_object::id >
            >
         >
      >,
      allocator< withdraw_coining_route_object >
   > withdraw_coining_route_index;
...
FC_REFLECT( voilk::chain::limit_order_object,
             (id)(created)(expiration)(seller)(orderid)(for_sale)(sell_price) )
CHAINBASE_SET_INDEX_TYPE( voilk::chain::limit_order_object, voilk::chain::limit_order_index )

FC_REFLECT( voilk::chain::feed_history_object,
             (id)(current_median_history)(price_history) )
CHAINBASE_SET_INDEX_TYPE( voilk::chain::feed_history_object, voilk::chain::feed_history_index )

FC_REFLECT( voilk::chain::convert_request_object,
             (id)(owner)(requestid)(amount)(conversion_date) )
CHAINBASE_SET_INDEX_TYPE( voilk::chain::convert_request_object, voilk::chain::convert_request_index )

FC_REFLECT( voilk::chain::liquidity_reward_balance_object,
             (id)(owner)(voilk_volume)(vsd_volume)(weight)(last_update) )
CHAINBASE_SET_INDEX_TYPE( voilk::chain::liquidity_reward_balance_object, voilk::chain::liquidity_reward_balance_index )

FC_REFLECT( voilk::chain::withdraw_coining_route_object,
             (id)(from_account)(to_account)(percent)(auto_coin) )
CHAINBASE_SET_INDEX_TYPE( voilk::chain::withdraw_coining_route_object, voilk::chain::withdraw_coining_route_index )

FC_REFLECT( voilk::chain::savings_withdraw_object,
             (id)(from)(to)(memo)(request_id)(amount)(complete) )
CHAINBASE_SET_INDEX_TYPE( voilk::chain::savings_withdraw_object, voilk::chain::savings_withdraw_index )

FC_REFLECT( voilk::chain::escrow_object,
             (id)(escrow_id)(from)(to)(agent)
             (ratification_deadline)(escrow_expiration)
             (vsd_balance)(voilk_balance)(pending_fee)
             (to_approved)(agent_approved)(disputed) )
CHAINBASE_SET_INDEX_TYPE( voilk::chain::escrow_object, voilk::chain::escrow_index )

FC_REFLECT( voilk::chain::decline_voting_rights_request_object,
             (id)(account)(effective_date) )
CHAINBASE_SET_INDEX_TYPE( voilk::chain::decline_voting_rights_request_object, voilk::chain::decline_voting_rights_request_index )

FC_REFLECT( voilk::chain::reward_fund_object,
            (id)
            (name)
            (reward_balance)
            (recent_claims)
...
CHAINBASE_SET_INDEX_TYPE( voilk::chain::reward_fund_object, voilk::chain::reward_fund_index )
