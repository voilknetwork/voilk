...
#include <voilk/chain/util/rd_dynamics.hpp>
...
namespace voilk { namespace chain {
   ...
   using voilk::protocol::digest_type;
   using voilk::protocol::public_key_type;
   using voilk::protocol::version;
   using voilk::protocol::hardfork_version;
   using voilk::protocol::price;
   using voilk::protocol::asset;
   using voilk::protocol::asset_symbol_type;
   using voilk::chain::util::rd_dynamics_params;
   ...
   struct chain_properties
   {
      ...
      asset             account_creation_fee =
         asset( VOILK_MIN_ACCOUNT_CREATION_FEE, VOILK_SYMBOL );
       ...
       * Scaled so that VOILK_ACCOUNT_SUBSIDY_PRECISION represents one account.
       */
       ...
       * Scaled so that 1 << VOILK_RD_DECAY_DENOM_SHIFT represents 100% of accounts
       * expiring.
       */
   ...
   class witness_object : public object< witness_object_type, witness_object >
   {
      ...
      public:
         ...
         /**
          * This field represents the Voilk blockchain version the witness is running.
          */
...
FC_REFLECT_ENUM( voilk::chain::witness_object::witness_schedule_type, (elected)(timeshare)(miner)(none) )

FC_REFLECT( voilk::chain::chain_properties,
...
FC_REFLECT( voilk::chain::witness_object,
             (id)
             (owner)
             (created)
...
CHAINBASE_SET_INDEX_TYPE( voilk::chain::witness_object, voilk::chain::witness_index )

FC_REFLECT( voilk::chain::witness_vote_object, (id)(witness)(account) )
CHAINBASE_SET_INDEX_TYPE( voilk::chain::witness_vote_object, voilk::chain::witness_vote_index )

FC_REFLECT( voilk::chain::witness_schedule_object,
...
CHAINBASE_SET_INDEX_TYPE( voilk::chain::witness_schedule_object, voilk::chain::witness_schedule_index )
