...
namespace voilk { namespace chain {
   ...
   using voilk::protocol::weight_type;
...
FC_REFLECT_TYPENAME( voilk::chain::shared_authority::account_authority_map)
FC_REFLECT( voilk::chain::shared_authority, (weight_threshold)(account_auths)(key_auths) )
