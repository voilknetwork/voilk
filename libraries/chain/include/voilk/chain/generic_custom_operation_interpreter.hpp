...
#include <voilk/chain/schema_types.hpp>
   ...
   : public custom_operation_interpreter, public evaluator_registry< CustomOperationType >
{
   public:
      ...
      virtual std::shared_ptr< voilk::schema::abstract_schema > get_operation_schema() override
      {
         return voilk::schema::get_schema_for_type< CustomOperationType >();
      }
};
