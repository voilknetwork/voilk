...
#include <bears/chain/util/rd_dynamics.hpp>
...
namespace bears { namespace chain {
   ...
   using bears::protocol::digest_type;
   using bears::protocol::public_key_type;
   using bears::protocol::version;
   using bears::protocol::hardfork_version;
   using bears::protocol::price;
   using bears::protocol::asset;
   using bears::protocol::asset_symbol_type;
   using bears::chain::util::rd_dynamics_params;
   ...
   struct chain_properties
   {
      ...
      asset             account_creation_fee =
         asset( BEARS_MIN_ACCOUNT_CREATION_FEE, BEARS_SYMBOL );
       ...
       * Scaled so that BEARS_ACCOUNT_SUBSIDY_PRECISION represents one account.
       */
       ...
       * Scaled so that 1 << BEARS_RD_DECAY_DENOM_SHIFT represents 100% of accounts
       * expiring.
       */
   ...
   class witness_object : public object< witness_object_type, witness_object >
   {
      ...
      public:
         ...
         /**
          * This field represents the Bears blockchain version the witness is running.
          */
   ...
   class witness_schedule_object : public object< witness_schedule_object_type, witness_schedule_object >
   {
      public:
         ...
         fc::array< account_name_type, BEARS_MAX_WITNESSES >             current_shuffled_witnesses;
...
FC_REFLECT_ENUM( bears::chain::witness_object::witness_schedule_type, (elected)(timeshare)(miner)(none) )

FC_REFLECT( bears::chain::chain_properties,
...
FC_REFLECT( bears::chain::witness_object,
             (id)
             (owner)
             (created)
...
CHAINBASE_SET_INDEX_TYPE( bears::chain::witness_object, bears::chain::witness_index )

FC_REFLECT( bears::chain::witness_vote_object, (id)(witness)(account) )
CHAINBASE_SET_INDEX_TYPE( bears::chain::witness_vote_object, bears::chain::witness_vote_index )

FC_REFLECT( bears::chain::witness_schedule_object,
...
CHAINBASE_SET_INDEX_TYPE( bears::chain::witness_schedule_object, bears::chain::witness_schedule_index )
