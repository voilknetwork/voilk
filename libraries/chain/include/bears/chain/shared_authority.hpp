...
namespace bears { namespace chain {
   ...
   using bears::protocol::weight_type;
...
FC_REFLECT_TYPENAME( bears::chain::shared_authority::account_authority_map)
FC_REFLECT( bears::chain::shared_authority, (weight_threshold)(account_auths)(key_auths) )
