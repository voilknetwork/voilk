...
FC_REFLECT( bears::chain::transaction_object, (id)(packed_trx)(trx_id)(expiration) )
CHAINBASE_SET_INDEX_TYPE( bears::chain::transaction_object, bears::chain::transaction_index )

namespace helpers
{
   template <>
   class index_statistic_provider<bears::chain::transaction_index>
   {
   public:
      typedef bears::chain::transaction_index IndexType;
      typedef typename bears::chain::transaction_object::t_packed_trx t_packed_trx;
