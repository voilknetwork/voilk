...
namespace bears { namespace chain {
   ...
   class account_object : public object< account_object_type, account_object >
   {
      ...
      public:
         ...
         account_name_type reset_account = BEARS_NULL_ACCOUNT;
          ...
          *  BEARS_MIN_COMPOUNDING_INTERVAL_SECONDS has past since bsd_last_interest_payment then
         ...
         fc::array<share_type, BEARS_MAX_PROXY_RECURSION_DEPTH> proxied_vsf_votes;// = std::vector<share_type>( BEARS_MAX_PROXY_RECURSION_DEPTH, 0 ); ///< the total VFS votes proxied to this account
...
FC_REFLECT( bears::chain::account_object,
...
CHAINBASE_SET_INDEX_TYPE( bears::chain::account_object, bears::chain::account_index )

FC_REFLECT( bears::chain::account_authority_object,
             (id)(account)(owner)(active)(posting)(last_owner_update)
)
CHAINBASE_SET_INDEX_TYPE( bears::chain::account_authority_object, bears::chain::account_authority_index )

FC_REFLECT( bears::chain::coining_delegation_object,
            (id)(delegator)(delegatee)(coining_shares)(min_delegation_time) )
CHAINBASE_SET_INDEX_TYPE( bears::chain::coining_delegation_object, bears::chain::coining_delegation_index )

FC_REFLECT( bears::chain::coining_delegation_expiration_object,
            (id)(delegator)(coining_shares)(expiration) )
CHAINBASE_SET_INDEX_TYPE( bears::chain::coining_delegation_expiration_object, bears::chain::coining_delegation_expiration_index )

FC_REFLECT( bears::chain::owner_authority_history_object,
             (id)(account)(previous_owner_authority)(last_valid_time)
          )
CHAINBASE_SET_INDEX_TYPE( bears::chain::owner_authority_history_object, bears::chain::owner_authority_history_index )

FC_REFLECT( bears::chain::account_recovery_request_object,
             (id)(account_to_recover)(new_owner_authority)(expires)
          )
CHAINBASE_SET_INDEX_TYPE( bears::chain::account_recovery_request_object, bears::chain::account_recovery_request_index )

FC_REFLECT( bears::chain::change_recovery_account_request_object,
             (id)(account_to_recover)(recovery_account)(effective_on)
          )
CHAINBASE_SET_INDEX_TYPE( bears::chain::change_recovery_account_request_object, bears::chain::change_recovery_account_request_index )
