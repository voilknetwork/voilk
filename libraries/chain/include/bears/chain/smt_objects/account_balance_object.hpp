...
public:   
   ...
   asset               liquid;   /// 'balance' for BEARS
...
public:   
   ...
   /// Name of the account, the balance is held for.
   account_name_type   owner;
   asset               pending_liquid;          /// 'reward_bears_balance' for pending BEARS
   asset               pending_coining_shares;  /// 'reward_coining_balance' for pending COINS
   asset               pending_coining_value;   /// 'reward_coining_bears' for pending COINS
...
FC_REFLECT( bears::chain::account_regular_balance_object,
   (id)
   (owner)
   (liquid)
   (coining)
...
FC_REFLECT( bears::chain::account_rewards_balance_object,
   (id)
   (owner)
   (pending_liquid)
...
CHAINBASE_SET_INDEX_TYPE( bears::chain::account_regular_balance_object, bears::chain::account_regular_balance_index )
CHAINBASE_SET_INDEX_TYPE( bears::chain::account_rewards_balance_object, bears::chain::account_rewards_balance_index )
