...
namespace bears { namespace chain {
   ...
   /**
    *  This object is used to track pending requests to convert bsd to bears
    */
    ...
    *  1000 BEARS or 1000 * virtual_supply / (100*blocks_per_year) aka 10 * virtual_supply / blocks_per_year
    *
   ...
   class liquidity_reward_balance_object : public object< liquidity_reward_balance_object_type, liquidity_reward_balance_object >
   {
      public:
         ...
         int64_t           bears_volume = 0;
         int64_t           bsd_volume = 0;
         uint128_t         weight = 0;
         ...
         {
            return bears_volume * bsd_volume * is_positive();
         }

         uint128_t min_volume_weight()const
         {
            return std::min(bears_volume,bsd_volume) * is_positive();
         }
         ...
         {
            return ( bears_volume > 0 && bsd_volume > 0 ) ? 1 : 0;
         }
   };
...
FC_REFLECT( bears::chain::limit_order_object,
             (id)(created)(expiration)(seller)(orderid)(for_sale)(sell_price) )
CHAINBASE_SET_INDEX_TYPE( bears::chain::limit_order_object, bears::chain::limit_order_index )

FC_REFLECT( bears::chain::feed_history_object,
             (id)(current_median_history)(price_history) )
CHAINBASE_SET_INDEX_TYPE( bears::chain::feed_history_object, bears::chain::feed_history_index )

FC_REFLECT( bears::chain::convert_request_object,
             (id)(owner)(requestid)(amount)(conversion_date) )
CHAINBASE_SET_INDEX_TYPE( bears::chain::convert_request_object, bears::chain::convert_request_index )

FC_REFLECT( bears::chain::liquidity_reward_balance_object,
             (id)(owner)(bears_volume)(bsd_volume)(weight)(last_update) )
CHAINBASE_SET_INDEX_TYPE( bears::chain::liquidity_reward_balance_object, bears::chain::liquidity_reward_balance_index )

FC_REFLECT( bears::chain::withdraw_coining_route_object,
             (id)(from_account)(to_account)(percent)(auto_coin) )
CHAINBASE_SET_INDEX_TYPE( bears::chain::withdraw_coining_route_object, bears::chain::withdraw_coining_route_index )

FC_REFLECT( bears::chain::savings_withdraw_object,
             (id)(from)(to)(memo)(request_id)(amount)(complete) )
CHAINBASE_SET_INDEX_TYPE( bears::chain::savings_withdraw_object, bears::chain::savings_withdraw_index )

FC_REFLECT( bears::chain::escrow_object,
             (id)(escrow_id)(from)(to)(agent)
             (ratification_deadline)(escrow_expiration)
             (bsd_balance)(bears_balance)(pending_fee)
             (to_approved)(agent_approved)(disputed) )
CHAINBASE_SET_INDEX_TYPE( bears::chain::escrow_object, bears::chain::escrow_index )

FC_REFLECT( bears::chain::decline_voting_rights_request_object,
             (id)(account)(effective_date) )
CHAINBASE_SET_INDEX_TYPE( bears::chain::decline_voting_rights_request_object, bears::chain::decline_voting_rights_request_index )

FC_REFLECT( bears::chain::reward_fund_object,
            (id)
            (name)
            (reward_balance)
            (recent_claims)
...
CHAINBASE_SET_INDEX_TYPE( bears::chain::reward_fund_object, bears::chain::reward_fund_index )
