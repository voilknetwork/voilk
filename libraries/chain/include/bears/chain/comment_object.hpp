...
namespace bears { namespace chain {
   ...
   class comment_object : public object < comment_object_type, comment_object >
   {
      ...
      public:
         ...
         /** tracks the total payout this comment has received over time, measured in BSD */
         asset             total_payout_value = asset(0, BSD_SYMBOL);
         asset             curator_payout_value = asset(0, BSD_SYMBOL);
         asset             beneficiary_payout_value = asset( 0, BSD_SYMBOL );
...
#ifdef BEARS_ENABLE_SMT
FC_REFLECT( bears::chain::comment_object,
             (id)(author)(permlink)
...
#endif
CHAINBASE_SET_INDEX_TYPE( bears::chain::comment_object, bears::chain::comment_index )

FC_REFLECT( bears::chain::comment_content_object,
            (id)(comment)(title)(body)(json_metadata) )
CHAINBASE_SET_INDEX_TYPE( bears::chain::comment_content_object, bears::chain::comment_content_index )

FC_REFLECT( bears::chain::comment_vote_object,
             (id)(voter)(comment)(weight)(rshares)(vote_percent)(last_update)(num_changes)
          )
CHAINBASE_SET_INDEX_TYPE( bears::chain::comment_vote_object, bears::chain::comment_vote_index )

namespace helpers
{
   using bears::chain::shared_string;
   
   template <>
   class index_statistic_provider<bears::chain::comment_index>
   {
   public:
      typedef bears::chain::comment_index IndexType;
      typedef typename bears::chain::comment_object::t_beneficiaries t_beneficiaries;
#ifdef BEARS_ENABLE_SMT
      typedef typename bears::chain::comment_object::t_votable_assets t_votable_assets;
#endif
   ...
   template <>
   class index_statistic_provider<bears::chain::comment_content_index>
   {
   public:
      typedef bears::chain::comment_content_index IndexType;
