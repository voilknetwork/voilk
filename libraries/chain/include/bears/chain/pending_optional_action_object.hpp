...
using bears::protocol::optional_automated_action;
...
FC_REFLECT( bears::chain::pending_optional_action_object,
            (id)(action) )
CHAINBASE_SET_INDEX_TYPE( bears::chain::pending_optional_action_object, bears::chain::pending_optional_action_index )
