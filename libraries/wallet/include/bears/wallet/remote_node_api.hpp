...
struct remote_node_api
{
   ...
   vector< database_api::api_withdraw_coining_route_object > get_withdraw_routes( account_name_type, condenser_api::withdraw_route_type );
   ...
   vector< condenser_api::api_coining_delegation_object > get_coining_delegations( account_name_type, account_name_type, uint32_t );
   vector< condenser_api::api_coining_delegation_expiration_object > get_expiring_coining_delegations( account_name_type, time_point_sec, uint32_t );
...
FC_API( bears::wallet::remote_node_api,
        (get_version)
        (get_trending_tags)
        (get_state)
