...
#ifndef VOILK_RC_SPACE_ID
#define VOILK_RC_SPACE_ID 16
#endif

enum rc_object_types
{
   rc_resource_param_object_type   = ( VOILK_RC_SPACE_ID << 8 ),
   rc_pool_object_type             = ( VOILK_RC_SPACE_ID << 8 ) + 1,
   rc_account_object_type          = ( VOILK_RC_SPACE_ID << 8 ) + 2
};
...
class rc_resource_param_object : public object< rc_resource_param_object_type, rc_resource_param_object >
{
   public:
      ...
      id_type               id;
      fc::int_array< rc_resource_params, VOILK_NUM_RESOURCE_TYPES >
...
class rc_pool_object : public object< rc_pool_object_type, rc_pool_object >
{
   public:
      ...
      id_type               id;
      fc::int_array< int64_t, VOILK_NUM_RESOURCE_TYPES >
                            pool_array;
};
...
class rc_account_object : public object< rc_account_object_type, rc_account_object >
{
   public:
      ...
      voilk::chain::util::manabar   rc_manabar;
...
int64_t get_maximum_rc( const voilk::chain::account_object& account, const rc_account_object& rc_account );
...
FC_REFLECT( voilk::plugins::rc::rc_resource_param_object, (id)(resource_param_array) )
CHAINBASE_SET_INDEX_TYPE( voilk::plugins::rc::rc_resource_param_object, voilk::plugins::rc::rc_resource_param_index )

FC_REFLECT( voilk::plugins::rc::rc_pool_object, (id)(pool_array) )
CHAINBASE_SET_INDEX_TYPE( voilk::plugins::rc::rc_pool_object, voilk::plugins::rc::rc_pool_index )

FC_REFLECT( voilk::plugins::rc::rc_account_object,
   (id)
   (account)
   (rc_manabar)
...
CHAINBASE_SET_INDEX_TYPE( voilk::plugins::rc::rc_account_object, voilk::plugins::rc::rc_account_index )
