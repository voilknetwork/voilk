...
struct state_object_size_info
{
   ...
   int64_t coining_delegation_object_base_size = 60*STATE_BYTES_SCALE;

   // coining_delegation_expiration_object
   int64_t coining_delegation_expiration_object_base_size = 44*STATE_BYTES_SCALE;

   // withdraw_coining_route_object
   int64_t withdraw_coining_route_object_base_size = 43*STATE_BYTES_SCALE;
...
struct operation_exec_info
{
   ...
   int64_t delegate_coining_shares_operation_exec_time         =  19900;
   ...
   int64_t withdraw_coining_operation_exec_time                =  10400;
...
FC_REFLECT( voilk::plugins::rc::state_object_size_info,
   ( authority_base_size )
   ...
   ( coining_delegation_object_base_size )
   ( coining_delegation_expiration_object_base_size )
   ( withdraw_coining_route_object_base_size )
   ( witness_object_base_size )
   ( witness_object_url_char_size )
   ( witness_vote_object_base_size )
   )

FC_REFLECT( voilk::plugins::rc::operation_exec_info,
   ...
   ( delegate_coining_shares_operation_exec_time )
   ...
   ( withdraw_coining_operation_exec_time )
