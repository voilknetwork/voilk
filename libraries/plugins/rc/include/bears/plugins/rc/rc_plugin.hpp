...
#define BEARS_RC_PLUGIN_NAME "rc"
...
struct rc_plugin_skip_flags
{
   ...
   uint32_t skip_reject_unknown_delta_coins : 1;
};
...
class rc_plugin : public appbase::plugin< rc_plugin >
{
   public:
      ...
      static const std::string& name() { static std::string name = BEARS_RC_PLUGIN_NAME; return name; }
