...
#ifndef BEARS_ACCOUNT_BY_KEY_SPACE_ID
#define BEARS_ACCOUNT_BY_KEY_SPACE_ID 11
#endif

enum account_by_key_object_types
{
   key_lookup_object_type = ( BEARS_ACCOUNT_BY_KEY_SPACE_ID << 8 )
};
...
FC_REFLECT( bears::plugins::account_by_key::key_lookup_object, (id)(key)(account) )
CHAINBASE_SET_INDEX_TYPE( bears::plugins::account_by_key::key_lookup_object, bears::plugins::account_by_key::key_lookup_index )
