...
namespace voilk { namespace plugins { namespace block_data_export {
...
FC_REFLECT( voilk::plugins::block_data_export::detail::api_export_data_object, (block_id)(previous)(export_data) )

namespace voilk { namespace plugins { namespace block_data_export { namespace detail {
...
} } } // voilk::plugins::block_data_export
