...
namespace bears { namespace plugins { namespace condenser_api {
   ...
   typedef set_withdraw_coining_route_operation   legacy_set_withdraw_coining_route_operation;
   ...
   struct api_chain_properties
   {
      ...
      api_chain_properties( const chain::chain_properties& c ) :
         ...
         bsd_interest_rate( c.bsd_interest_rate ),
      ...
      operator legacy_chain_properties() const
      {
         ...
         props.account_creation_fee = legacy_bears_asset::from_asset( asset( account_creation_fee ) );
         props.maximum_block_size = maximum_block_size;
         props.bsd_interest_rate = bsd_interest_rate;
         return props;
      }

      legacy_asset   account_creation_fee;
      uint32_t       maximum_block_size = BEARS_MIN_BLOCK_SIZE_LIMIT * 2;
      uint16_t       bsd_interest_rate = BEARS_DEFAULT_BSD_INTEREST_RATE;
      int32_t        account_subsidy_budget = BEARS_DEFAULT_ACCOUNT_SUBSIDY_BUDGET;
      uint32_t       account_subsidy_decay = BEARS_DEFAULT_ACCOUNT_SUBSIDY_DECAY;
   };
   ...
   struct legacy_comment_options_operation
   {
      ...
      legacy_comment_options_operation( const comment_options_operation& op ) :
         ...
         percent_bears_dollars( op.percent_bears_dollars ),
      ...
      operator comment_options_operation()const
      {
         ...
         op.percent_bears_dollars = percent_bears_dollars;
      ...
      uint16_t          percent_bears_dollars;
      bool              allow_votes;
   ...
   struct legacy_escrow_transfer_operation
   {
      ...
      legacy_escrow_transfer_operation( const escrow_transfer_operation& op ) :
         ...
         bsd_amount( legacy_asset::from_asset( op.bsd_amount ) ),
         bears_amount( legacy_asset::from_asset( op.bears_amount ) ),
         fee( legacy_asset::from_asset( op.fee ) ),
      ...
      operator escrow_transfer_operation()const
      {
         ...
         op.bsd_amount = bsd_amount;
         op.bears_amount = bears_amount;
         op.fee = fee;
      ...
      legacy_asset      bsd_amount;
      legacy_asset      bears_amount;
      legacy_asset      fee;
   ...
   struct legacy_pow2_operation
   {
         ...
         new_owner_key( op.new_owner_key )
      {
         ...
         props.bsd_interest_rate = op.props.bsd_interest_rate;
      }
      ...
      operator pow2_operation()const
      {
         ...
         op.props.account_creation_fee = legacy_bears_asset::from_asset( asset( props.account_creation_fee ) );
         op.props.maximum_block_size = props.maximum_block_size;
         op.props.bsd_interest_rate = props.bsd_interest_rate;
         return op;
      }
   ...
   struct legacy_transfer_to_coining_operation
   {
      legacy_transfer_to_coining_operation() {}
      legacy_transfer_to_coining_operation( const transfer_to_coining_operation& op ) :
         from( op.from ),
         to( op.to ),
         amount( legacy_asset::from_asset( op.amount ) )
      {}

      operator transfer_to_coining_operation()const
      {
   ...
   struct legacy_withdraw_coining_operation
   {
      legacy_withdraw_coining_operation() {}
      legacy_withdraw_coining_operation( const withdraw_coining_operation& op ) :
         account( op.account ),
         coining_shares( legacy_asset::from_asset( op.coining_shares) )
      {}

      operator withdraw_coining_operation()const
      {
         withdraw_coining_operation op;
         op.account = account;
         op.coining_shares = coining_shares;
         return op;
      }

      account_name_type account;
      legacy_asset      coining_shares;
   };
   ...
   struct legacy_claim_reward_balance_operation
   {
      ...
      legacy_claim_reward_balance_operation( const claim_reward_balance_operation& op ) :
         account( op.account ),
         reward_bears( legacy_asset::from_asset( op.reward_bears ) ),
         reward_bsd( legacy_asset::from_asset( op.reward_bsd ) ),
         reward_coins( legacy_asset::from_asset( op.reward_coins ) )
      {}
      ...
      operator claim_reward_balance_operation()const
      {
         ...
         op.account = account;
         op.reward_bears = reward_bears;
         op.reward_bsd = reward_bsd;
         op.reward_coins = reward_coins;
         return op;
      }

      account_name_type account;
      legacy_asset      reward_bears;
      legacy_asset      reward_bsd;
      legacy_asset      reward_coins;
   };

   struct legacy_delegate_coining_shares_operation
   {
      legacy_delegate_coining_shares_operation() {}
      legacy_delegate_coining_shares_operation( const delegate_coining_shares_operation& op ) :
         delegator( op.delegator ),
         delegatee( op.delegatee ),
         coining_shares( legacy_asset::from_asset( op.coining_shares ) )
      {}

      operator delegate_coining_shares_operation()const
      {
   ...
   struct legacy_author_reward_operation
   {
      ...
      legacy_author_reward_operation( const author_reward_operation& op ) :
         author( op.author ),
         permlink( op.permlink ),
         bsd_payout( legacy_asset::from_asset( op.bsd_payout ) ),
         bears_payout( legacy_asset::from_asset( op.bears_payout ) ),
         coining_payout( legacy_asset::from_asset( op.coining_payout ) )
      {}
      ...
      operator author_reward_operation()const
      {
         ...
         op.author = author;
         op.permlink = permlink;
         op.bsd_payout = bsd_payout;
         op.bears_payout = bears_payout;
         op.coining_payout = coining_payout;
         return op;
      }

      account_name_type author;
      string            permlink;
      legacy_asset      bsd_payout;
      legacy_asset      bears_payout;
      legacy_asset      coining_payout;
   };
   ...
   struct legacy_fill_coining_withdraw_operation
   {
      legacy_fill_coining_withdraw_operation() {}
      legacy_fill_coining_withdraw_operation( const fill_coining_withdraw_operation& op ) :
      ...
      operator fill_coining_withdraw_operation()const
      {
         fill_coining_withdraw_operation op;
   ...
   struct legacy_return_coining_delegation_operation
   {
      legacy_return_coining_delegation_operation() {}
      legacy_return_coining_delegation_operation( const return_coining_delegation_operation& op ) :
         account( op.account ),
         coining_shares( legacy_asset::from_asset( op.coining_shares ) )
      {}

      operator return_coining_delegation_operation()const
      {
         return_coining_delegation_operation op;
         op.account = account;
         op.coining_shares = coining_shares;
         return op;
      }
   ...
   typedef fc::static_variant<
            ...
            legacy_comment_options_operation,
            legacy_set_withdraw_coining_route_operation,
            legacy_limit_order_create2_operation,
            legacy_claim_account_operation,
   ...
   struct legacy_operation_conversion_visitor
   {
      ...
      bool operator()( const set_withdraw_coining_route_operation& op )const     { l_op = op; return true; }
      ...
      {
         l_op = legacy_transfer_to_coining_operation( op );
         return true;
      }

      bool operator()( const withdraw_coining_operation& op )const
      {
         l_op = legacy_withdraw_coining_operation( op );
         return true;
      }
      ...
      bool operator()( const delegate_coining_shares_operation& op )const
      {
         l_op = legacy_delegate_coining_shares_operation( op );
         return true;
      }
      ...
      bool operator()( const fill_coining_withdraw_operation& op )const
      {
         l_op = legacy_fill_coining_withdraw_operation( op );
         return true;
      }
      ...
      bool operator()( const return_coining_delegation_operation& op )const
      {
         l_op = legacy_return_coining_delegation_operation( op );
         return true;
      }
...
struct convert_from_legacy_operation_visitor
{
   ...
   {
      return operation( transfer_to_coining_operation( op ) );
   }

   operation operator()( const legacy_withdraw_coining_operation& op )const
   {
      return operation( withdraw_coining_operation( op ) );
   }
   ...
   operation operator()( const legacy_delegate_coining_shares_operation& op )const
   {
      return operation( delegate_coining_shares_operation( op ) );
   }
   ...
   operation operator()( const legacy_fill_coining_withdraw_operation& op )const
   {
      return operation( fill_coining_withdraw_operation( op ) );
   }
   ...
   operation operator()( const legacy_return_coining_delegation_operation& op )const
   {
      return operation( return_coining_delegation_operation( op ) );
   }
...
void to_variant( const bears::plugins::condenser_api::legacy_operation&, fc::variant& );
void from_variant( const fc::variant&, bears::plugins::condenser_api::legacy_operation& );

void to_variant( const bears::plugins::condenser_api::legacy_comment_options_extensions&, fc::variant& );
void from_variant( const fc::variant&, bears::plugins::condenser_api::legacy_comment_options_extensions& );

void to_variant( const bears::plugins::condenser_api::legacy_pow2_work&, fc::variant& );
void from_variant( const fc::variant&, bears::plugins::condenser_api::legacy_pow2_work& );
...
FC_REFLECT( bears::plugins::condenser_api::api_chain_properties,
            (account_creation_fee)(maximum_block_size)(bsd_interest_rate)(account_subsidy_budget)(account_subsidy_decay)
          )

FC_REFLECT( bears::plugins::condenser_api::legacy_price, (base)(quote) )
FC_REFLECT( bears::plugins::condenser_api::legacy_transfer_to_savings_operation, (from)(to)(amount)(memo) )
FC_REFLECT( bears::plugins::condenser_api::legacy_transfer_from_savings_operation, (from)(request_id)(to)(amount)(memo) )
FC_REFLECT( bears::plugins::condenser_api::legacy_convert_operation, (owner)(requestid)(amount) )
FC_REFLECT( bears::plugins::condenser_api::legacy_feed_publish_operation, (publisher)(exchange_rate) )

FC_REFLECT( bears::plugins::condenser_api::legacy_account_create_operation,
            (fee)
            (creator)
            (new_account_name)
            (owner)
...
FC_REFLECT( bears::plugins::condenser_api::legacy_account_create_with_delegation_operation,
            (fee)
            (delegation)
            (creator)
            (new_account_name)
...
FC_REFLECT( bears::plugins::condenser_api::legacy_transfer_operation, (from)(to)(amount)(memo) )
FC_REFLECT( bears::plugins::condenser_api::legacy_transfer_to_coining_operation, (from)(to)(amount) )
FC_REFLECT( bears::plugins::condenser_api::legacy_withdraw_coining_operation, (account)(coining_shares) )
FC_REFLECT( bears::plugins::condenser_api::legacy_witness_update_operation, (owner)(url)(block_signing_key)(props)(fee) )
FC_REFLECT( bears::plugins::condenser_api::legacy_limit_order_create_operation, (owner)(orderid)(amount_to_sell)(min_to_receive)(fill_or_kill)(expiration) )
FC_REFLECT( bears::plugins::condenser_api::legacy_limit_order_create2_operation, (owner)(orderid)(amount_to_sell)(exchange_rate)(fill_or_kill)(expiration) )
FC_REFLECT( bears::plugins::condenser_api::legacy_comment_options_operation, (author)(permlink)(max_accepted_payout)(percent_bears_dollars)(allow_votes)(allow_curation_rewards)(extensions) )
FC_REFLECT( bears::plugins::condenser_api::legacy_escrow_transfer_operation, (from)(to)(bsd_amount)(bears_amount)(escrow_id)(agent)(fee)(json_meta)(ratification_deadline)(escrow_expiration) );
FC_REFLECT( bears::plugins::condenser_api::legacy_escrow_release_operation, (from)(to)(agent)(who)(receiver)(escrow_id)(bsd_amount)(bears_amount) );
FC_REFLECT( bears::plugins::condenser_api::legacy_pow2_operation, (work)(new_owner_key)(props) )
FC_REFLECT( bears::plugins::condenser_api::legacy_claim_reward_balance_operation, (account)(reward_bears)(reward_bsd)(reward_coins) )
FC_REFLECT( bears::plugins::condenser_api::legacy_delegate_coining_shares_operation, (delegator)(delegatee)(coining_shares) );
FC_REFLECT( bears::plugins::condenser_api::legacy_author_reward_operation, (author)(permlink)(bsd_payout)(bears_payout)(coining_payout) )
FC_REFLECT( bears::plugins::condenser_api::legacy_curation_reward_operation, (curator)(reward)(comment_author)(comment_permlink) )
FC_REFLECT( bears::plugins::condenser_api::legacy_comment_reward_operation, (author)(permlink)(payout) )
FC_REFLECT( bears::plugins::condenser_api::legacy_fill_convert_request_operation, (owner)(requestid)(amount_in)(amount_out) )
FC_REFLECT( bears::plugins::condenser_api::legacy_liquidity_reward_operation, (owner)(payout) )
FC_REFLECT( bears::plugins::condenser_api::legacy_interest_operation, (owner)(interest) )
FC_REFLECT( bears::plugins::condenser_api::legacy_fill_coining_withdraw_operation, (from_account)(to_account)(withdrawn)(deposited) )
FC_REFLECT( bears::plugins::condenser_api::legacy_fill_order_operation, (current_owner)(current_orderid)(current_pays)(open_owner)(open_orderid)(open_pays) )
FC_REFLECT( bears::plugins::condenser_api::legacy_fill_transfer_from_savings_operation, (from)(to)(amount)(request_id)(memo) )
FC_REFLECT( bears::plugins::condenser_api::legacy_return_coining_delegation_operation, (account)(coining_shares) )
FC_REFLECT( bears::plugins::condenser_api::legacy_comment_benefactor_reward_operation, (benefactor)(author)(permlink)(bsd_payout)(bears_payout)(coining_payout) )
FC_REFLECT( bears::plugins::condenser_api::legacy_producer_reward_operation, (producer)(coining_shares) )
FC_REFLECT( bears::plugins::condenser_api::legacy_claim_account_operation, (creator)(fee)(extensions) )

FC_REFLECT_TYPENAME( bears::plugins::condenser_api::legacy_operation )
