...
struct api_account_object
{
   api_account_object( const database_api::api_account_object& a ) :
      ...
      bsd_balance( legacy_asset::from_asset( a.bsd_balance ) ),
      bsd_seconds( a.bsd_seconds ),
      bsd_seconds_last_update( a.bsd_seconds_last_update ),
      bsd_last_interest_payment( a.bsd_last_interest_payment ),
      savings_bsd_balance( legacy_asset::from_asset( a.savings_bsd_balance ) ),
      savings_bsd_seconds( a.savings_bsd_seconds ),
      savings_bsd_seconds_last_update( a.savings_bsd_seconds_last_update ),
      savings_bsd_last_interest_payment( a.savings_bsd_last_interest_payment ),
      savings_withdraw_requests( a.savings_withdraw_requests ),
      reward_bsd_balance( legacy_asset::from_asset( a.reward_bsd_balance ) ),
      reward_bears_balance( legacy_asset::from_asset( a.reward_bears_balance ) ),
      reward_coining_balance( legacy_asset::from_asset( a.reward_coining_balance ) ),
      reward_coining_bears( legacy_asset::from_asset( a.reward_coining_bears ) ),
      curation_rewards( a.curation_rewards ),
      posting_rewards( a.posting_rewards ),
      coining_shares( legacy_asset::from_asset( a.coining_shares ) ),
      delegated_coining_shares( legacy_asset::from_asset( a.delegated_coining_shares ) ),
      received_coining_shares( legacy_asset::from_asset( a.received_coining_shares ) ),
      coining_withdraw_rate( legacy_asset::from_asset( a.coining_withdraw_rate ) ),
      next_coining_withdrawal( a.next_coining_withdrawal ),
   ...
   legacy_asset      bsd_balance;
   uint128_t         bsd_seconds;
   time_point_sec    bsd_seconds_last_update;
   time_point_sec    bsd_last_interest_payment;

   legacy_asset      savings_bsd_balance;
   uint128_t         savings_bsd_seconds;
   time_point_sec    savings_bsd_seconds_last_update;
   time_point_sec    savings_bsd_last_interest_payment;

   uint8_t           savings_withdraw_requests = 0;

   legacy_asset      reward_bsd_balance;
   legacy_asset      reward_bears_balance;
   legacy_asset      reward_coining_balance;
   legacy_asset      reward_coining_bears;

   share_type        curation_rewards;
   share_type        posting_rewards;

   legacy_asset      coining_shares;
   legacy_asset      delegated_coining_shares;
   legacy_asset      received_coining_shares;
   legacy_asset      coining_withdraw_rate;
   time_point_sec    next_coining_withdrawal;
...
struct extended_account : public api_account_object
{
   ...
   legacy_asset                                             coining_balance;  /// convert coining_shares to coining bears
   share_type                                               reputation = 0;
   map< uint64_t, api_operation_object >   transfer_history; /// transfer to/from coining
...
struct api_comment_object
{
   api_comment_object( const database_api::api_comment_object& c ):
      ...
      percent_bears_dollars( c.percent_bears_dollars ),
   ...
   uint16_t          percent_bears_dollars = 0;
...
struct extended_dynamic_global_properties
{
   ...
   extended_dynamic_global_properties( const database_api::api_dynamic_global_property_object& o ) :
      ...
      current_bsd_supply( legacy_asset::from_asset( o.current_bsd_supply ) ),
      confidential_bsd_supply( legacy_asset::from_asset( o.confidential_bsd_supply ) ),
      total_coining_fund_bears( legacy_asset::from_asset( o.total_coining_fund_bears ) ),
      total_coining_shares( legacy_asset::from_asset( o.total_coining_shares ) ),
      total_reward_fund_bears( legacy_asset::from_asset( o.total_reward_fund_bears ) ),
      total_reward_shares2( o.total_reward_shares2 ),
      pending_rewarded_coining_shares( legacy_asset::from_asset( o.pending_rewarded_coining_shares ) ),
      pending_rewarded_coining_bears( legacy_asset::from_asset( o.pending_rewarded_coining_bears ) ),
      bsd_interest_rate( o.bsd_interest_rate ),
      bsd_print_rate( o.bsd_print_rate ),
      ...
      bsd_stop_percent( o.bsd_stop_percent ),
      bsd_start_percent( o.bsd_start_percent )
   {}
   ...
   legacy_asset      current_bsd_supply;
   legacy_asset      confidential_bsd_supply;
   legacy_asset      total_coining_fund_bears;
   legacy_asset      total_coining_shares;
   legacy_asset      total_reward_fund_bears;
   fc::uint128       total_reward_shares2;
   legacy_asset      pending_rewarded_coining_shares;
   legacy_asset      pending_rewarded_coining_bears;

   uint16_t          bsd_interest_rate = 0;
   uint16_t          bsd_print_rate = BEARS_100_PERCENT;
   ...
   uint32_t          vote_power_reserve_rate = BEARS_INITIAL_VOTE_POWER_RATE;
   uint32_t          delegation_return_period = BEARS_DELEGATION_RETURN_PERIOD_HF0;
...
struct api_witness_object
{
   ...
   api_witness_object( const database_api::api_witness_object& w ) :
      ...
      props( w.props ),
      bsd_exchange_rate( w.bsd_exchange_rate ),
      last_bsd_exchange_update( w.last_bsd_exchange_update ),
      votes( w.votes ),
   ...
   legacy_price            bsd_exchange_rate;
   ...
   time_point_sec          hardfork_time_vote = BEARS_GENESIS_TIME;
...
struct api_witness_schedule_object
{
   ...
   uint8_t                       max_voted_witnesses           = BEARS_MAX_VOTED_WITNESSES_HF0;
   uint8_t                       max_miner_witnesses           = BEARS_MAX_MINER_WITNESSES_HF0;
   uint8_t                       max_runner_witnesses          = BEARS_MAX_RUNNER_WITNESSES_HF0;
   uint8_t                       hardfork_required_witnesses   = BEARS_HARDFORK_REQUIRED_WITNESSES;
...
struct api_escrow_object
{
   ...
   api_escrow_object( const database_api::api_escrow_object& e ) :
      ...
      bsd_balance( legacy_asset::from_asset( e.bsd_balance ) ),
      bears_balance( legacy_asset::from_asset( e.bears_balance ) ),
...
struct api_coining_delegation_object
{
   api_coining_delegation_object() {}
   api_coining_delegation_object( const database_api::api_coining_delegation_object& v ) :
      id( v.id ),
      delegator( v.delegator ),
      delegatee( v.delegatee ),
      coining_shares( legacy_asset::from_asset( v.coining_shares ) ),
      min_delegation_time( v.min_delegation_time )
   {}

   coining_delegation_id_type id;
...
struct api_coining_delegation_expiration_object
{
   api_coining_delegation_expiration_object() {}
   api_coining_delegation_expiration_object( const database_api::api_coining_delegation_expiration_object& v ) :
      id( v.id ),
      delegator( v.delegator ),
      coining_shares( legacy_asset::from_asset( v.coining_shares ) ),
   ...
   coining_delegation_expiration_id_type id;
   account_name_type delegator;
   legacy_asset      coining_shares;
   time_point_sec    expiration;
};
...
struct discussion : public api_comment_object
{
   ...
   string                        root_title;
   legacy_asset                  pending_payout_value; ///< bsd
   legacy_asset                  total_pending_payout_value; ///< bsd including replies
...
struct get_version_return
{
   ...
   get_version_return( fc::string bc_v, fc::string s_v, fc::string fc_v )
      :blockchain_version( bc_v ), bears_revision( s_v ), fc_revision( fc_v ) {}

   fc::string blockchain_version;
   fc::string bears_revision;
...
struct ticker
{
   ...
   ticker( const market_history::get_ticker_return& t ) :
      ...
      bears_volume( legacy_asset::from_asset( t.bears_volume ) ),
      bsd_volume( legacy_asset::from_asset( t.bsd_volume ) )
   {}
   ...
   legacy_asset   bears_volume;
   legacy_asset   bsd_volume;
};
...
struct volume
{
   ...
   volume( const market_history::get_volume_return& v ) :
      bears_volume( legacy_asset::from_asset( v.bears_volume ) ),
      bsd_volume( legacy_asset::from_asset( v.bsd_volume ) )
   {}
...
DEFINE_API_ARGS( get_withdraw_routes,                    vector< variant >,   vector< database_api::api_withdraw_coining_route_object > )
...
DEFINE_API_ARGS( get_coining_delegations,                vector< variant >,   vector< api_coining_delegation_object > )
DEFINE_API_ARGS( get_expiring_coining_delegations,       vector< variant >,   vector< api_coining_delegation_expiration_object > )
...
FC_REFLECT( bears::plugins::condenser_api::discussion_index,
...
FC_REFLECT( bears::plugins::condenser_api::api_account_object,
             ...
             (reward_bsd_balance)(reward_bears_balance)(reward_coining_balance)(reward_coining_bears)
             (coining_shares)(delegated_coining_shares)(received_coining_shares)(coining_withdraw_rate)(next_coining_withdrawal)(withdrawn)(to_withdraw)(withdraw_routes)
             (curation_rewards)
             (posting_rewards)
...
FC_REFLECT_DERIVED( bears::plugins::condenser_api::extended_account, (bears::plugins::condenser_api::api_account_object),
            ...
            (coining_balance)(reputation)(transfer_history)(market_history)(post_history)(vote_history)(other_history)(witness_votes)(tags_usage)(guest_bloggers)(open_orders)(comments)(feed)(blog)(recent_replies)(recommended) )

FC_REFLECT( bears::plugins::condenser_api::api_comment_object,
             (id)(author)(permlink)
             ...
             (max_accepted_payout)(percent_bears_dollars)(allow_replies)(allow_votes)(allow_curation_rewards)
             (beneficiaries)
          )

FC_REFLECT( bears::plugins::condenser_api::extended_dynamic_global_properties,
            (head_block_number)(head_block_id)(time)
            (current_witness)(total_pow)(num_pow_witnesses)
            (virtual_supply)(current_supply)(confidential_supply)(current_bsd_supply)(confidential_bsd_supply)
            (total_coining_fund_bears)(total_coining_shares)
            (total_reward_fund_bears)(total_reward_shares2)(pending_rewarded_coining_shares)(pending_rewarded_coining_bears)
            (bsd_interest_rate)(bsd_print_rate)
            ...
            (delegation_return_period)(reverse_auction_seconds)(bsd_stop_percent)(bsd_start_percent)
            (average_block_size)(current_reserve_ratio)(max_virtual_bandwidth) )

FC_REFLECT( bears::plugins::condenser_api::api_witness_object,
             (id)
             (owner)
             (created)
             ...
             (props)
             (bsd_exchange_rate)(last_bsd_exchange_update)
             (last_work)
             (running_version)
...
FC_REFLECT( bears::plugins::condenser_api::api_witness_schedule_object,
             (id)
...
FC_REFLECT( bears::plugins::condenser_api::api_feed_history_object,
             (id)
             (current_median_history)
             (price_history)
          )

FC_REFLECT( bears::plugins::condenser_api::api_reward_fund_object,
            (id)
            (name)
            (reward_balance)
            (recent_claims)
...
FC_REFLECT( bears::plugins::condenser_api::api_escrow_object,
             (id)(escrow_id)(from)(to)(agent)
             (ratification_deadline)(escrow_expiration)
             (bsd_balance)(bears_balance)(pending_fee)
             (to_approved)(agent_approved)(disputed) )

FC_REFLECT( bears::plugins::condenser_api::api_savings_withdraw_object,
             (id)
             (from)
             (to)
             (memo)
...
FC_REFLECT( bears::plugins::condenser_api::api_coining_delegation_object,
            (id)(delegator)(delegatee)(coining_shares)(min_delegation_time) )

FC_REFLECT( bears::plugins::condenser_api::api_coining_delegation_expiration_object,
            (id)(delegator)(coining_shares)(expiration) )

FC_REFLECT( bears::plugins::condenser_api::api_convert_request_object,
             (id)(owner)(requestid)(amount)(conversion_date) )

FC_REFLECT_DERIVED( bears::plugins::condenser_api::discussion, (bears::plugins::condenser_api::api_comment_object),
...
FC_REFLECT( bears::plugins::condenser_api::scheduled_hardfork,
            (hf_version)(live_time) )

FC_REFLECT( bears::plugins::condenser_api::account_vote,
            (authorperm)(weight)(rshares)(percent)(time) )

FC_REFLECT( bears::plugins::condenser_api::tag_index, (trending) )

FC_REFLECT_ENUM( bears::plugins::condenser_api::withdraw_route_type, (incoming)(outgoing)(all) )

FC_REFLECT( bears::plugins::condenser_api::get_version_return,
            (blockchain_version)(bears_revision)(fc_revision) )

FC_REFLECT( bears::plugins::condenser_api::broadcast_transaction_synchronous_return,
            (id)(block_num)(trx_num)(expired) )

FC_REFLECT( bears::plugins::condenser_api::comment_feed_entry,
            (comment)(reblog_by)(reblog_on)(entry_id) )

FC_REFLECT( bears::plugins::condenser_api::comment_blog_entry,
            (comment)(blog)(reblog_on)(entry_id) )

FC_REFLECT( bears::plugins::condenser_api::ticker,
            (latest)(lowest_ask)(highest_bid)(percent_change)(bears_volume)(bsd_volume) )

FC_REFLECT( bears::plugins::condenser_api::volume,
            (bears_volume)(bsd_volume) )

FC_REFLECT( bears::plugins::condenser_api::order,
            (order_price)(real_price)(bears)(bsd)(created) )

FC_REFLECT( bears::plugins::condenser_api::order_book,
            (bids)(asks) )

FC_REFLECT( bears::plugins::condenser_api::market_trade,
