...
namespace voilk { namespace plugins { namespace condenser_api {
   ...
   struct api_chain_properties
   {
      ...
      api_chain_properties( const chain::chain_properties& c ) :
         ...
         vsd_interest_rate( c.vsd_interest_rate ),
      ...
      operator legacy_chain_properties() const
      {
         ...
         props.account_creation_fee = legacy_voilk_asset::from_asset( asset( account_creation_fee ) );
         props.maximum_block_size = maximum_block_size;
         props.vsd_interest_rate = vsd_interest_rate;
         return props;
      }

      legacy_asset   account_creation_fee;
      uint32_t       maximum_block_size = VOILK_MIN_BLOCK_SIZE_LIMIT * 2;
      uint16_t       vsd_interest_rate = VOILK_DEFAULT_VSD_INTEREST_RATE;
      int32_t        account_subsidy_budget = VOILK_DEFAULT_ACCOUNT_SUBSIDY_BUDGET;
      uint32_t       account_subsidy_decay = VOILK_DEFAULT_ACCOUNT_SUBSIDY_DECAY;
   };
   ...
   struct legacy_comment_options_operation
   {
      ...
      legacy_comment_options_operation( const comment_options_operation& op ) :
         ...
         percent_voilk_dollars( op.percent_voilk_dollars ),
      ...
      operator comment_options_operation()const
      {
         ...
         op.percent_voilk_dollars = percent_voilk_dollars;
      ...
      uint16_t          percent_voilk_dollars;
      bool              allow_votes;
   ...
   struct legacy_escrow_transfer_operation
   {
      ...
      legacy_escrow_transfer_operation( const escrow_transfer_operation& op ) :
         ...
         vsd_amount( legacy_asset::from_asset( op.vsd_amount ) ),
         voilk_amount( legacy_asset::from_asset( op.voilk_amount ) ),
         fee( legacy_asset::from_asset( op.fee ) ),
      ...
      operator escrow_transfer_operation()const
      {
         ...
         op.vsd_amount = vsd_amount;
         op.voilk_amount = voilk_amount;
         op.fee = fee;
      ...
      legacy_asset      vsd_amount;
      legacy_asset      voilk_amount;
      legacy_asset      fee;
   ...
   struct legacy_pow2_operation
   {
         ...
         new_owner_key( op.new_owner_key )
      {
         ...
         props.vsd_interest_rate = op.props.vsd_interest_rate;
      }
      ...
      operator pow2_operation()const
      {
         ...
         op.props.account_creation_fee = legacy_voilk_asset::from_asset( asset( props.account_creation_fee ) );
         op.props.maximum_block_size = props.maximum_block_size;
         op.props.vsd_interest_rate = props.vsd_interest_rate;
         return op;
      }
   ...
   struct legacy_claim_reward_balance_operation
   {
      ...
      legacy_claim_reward_balance_operation( const claim_reward_balance_operation& op ) :
         account( op.account ),
         reward_voilk( legacy_asset::from_asset( op.reward_voilk ) ),
         reward_vsd( legacy_asset::from_asset( op.reward_vsd ) ),
      ...
      operator claim_reward_balance_operation()const
      {
         ...
         op.account = account;
         op.reward_voilk = reward_voilk;
         op.reward_vsd = reward_vsd;
         op.reward_coins = reward_coins;
         return op;
      }

      account_name_type account;
      legacy_asset      reward_voilk;
      legacy_asset      reward_vsd;
   ...
   struct legacy_author_reward_operation
   {
      ...
      legacy_author_reward_operation( const author_reward_operation& op ) :
         author( op.author ),
         permlink( op.permlink ),
         vsd_payout( legacy_asset::from_asset( op.vsd_payout ) ),
         voilk_payout( legacy_asset::from_asset( op.voilk_payout ) ),
      ...
      operator author_reward_operation()const
      {
         ...
         op.author = author;
         op.permlink = permlink;
         op.vsd_payout = vsd_payout;
         op.voilk_payout = voilk_payout;
      ...
      account_name_type author;
      string            permlink;
      legacy_asset      vsd_payout;
      legacy_asset      voilk_payout;
...
void to_variant( const voilk::plugins::condenser_api::legacy_operation&, fc::variant& );
void from_variant( const fc::variant&, voilk::plugins::condenser_api::legacy_operation& );

void to_variant( const voilk::plugins::condenser_api::legacy_comment_options_extensions&, fc::variant& );
void from_variant( const fc::variant&, voilk::plugins::condenser_api::legacy_comment_options_extensions& );

void to_variant( const voilk::plugins::condenser_api::legacy_pow2_work&, fc::variant& );
void from_variant( const fc::variant&, voilk::plugins::condenser_api::legacy_pow2_work& );
...
FC_REFLECT( voilk::plugins::condenser_api::api_chain_properties,
            (account_creation_fee)(maximum_block_size)(vsd_interest_rate)(account_subsidy_budget)(account_subsidy_decay)
          )

FC_REFLECT( voilk::plugins::condenser_api::legacy_price, (base)(quote) )
FC_REFLECT( voilk::plugins::condenser_api::legacy_transfer_to_savings_operation, (from)(to)(amount)(memo) )
FC_REFLECT( voilk::plugins::condenser_api::legacy_transfer_from_savings_operation, (from)(request_id)(to)(amount)(memo) )
FC_REFLECT( voilk::plugins::condenser_api::legacy_convert_operation, (owner)(requestid)(amount) )
FC_REFLECT( voilk::plugins::condenser_api::legacy_feed_publish_operation, (publisher)(exchange_rate) )

FC_REFLECT( voilk::plugins::condenser_api::legacy_account_create_operation,
            (fee)
            (creator)
            (new_account_name)
            (owner)
...
FC_REFLECT( voilk::plugins::condenser_api::legacy_account_create_with_delegation_operation,
            (fee)
            (delegation)
            (creator)
            (new_account_name)
...
FC_REFLECT( voilk::plugins::condenser_api::legacy_limit_order_create_operation, (owner)(orderid)(amount_to_sell)(min_to_receive)(fill_or_kill)(expiration) )
FC_REFLECT( voilk::plugins::condenser_api::legacy_limit_order_create2_operation, (owner)(orderid)(amount_to_sell)(exchange_rate)(fill_or_kill)(expiration) )
FC_REFLECT( voilk::plugins::condenser_api::legacy_comment_options_operation, (author)(permlink)(max_accepted_payout)(percent_voilk_dollars)(allow_votes)(allow_curation_rewards)(extensions) )
FC_REFLECT( voilk::plugins::condenser_api::legacy_escrow_transfer_operation, (from)(to)(vsd_amount)(voilk_amount)(escrow_id)(agent)(fee)(json_meta)(ratification_deadline)(escrow_expiration) );
FC_REFLECT( voilk::plugins::condenser_api::legacy_escrow_release_operation, (from)(to)(agent)(who)(receiver)(escrow_id)(vsd_amount)(voilk_amount) );
FC_REFLECT( voilk::plugins::condenser_api::legacy_pow2_operation, (work)(new_owner_key)(props) )
FC_REFLECT( voilk::plugins::condenser_api::legacy_claim_reward_balance_operation, (account)(reward_voilk)(reward_vsd)(reward_coins) )
FC_REFLECT( voilk::plugins::condenser_api::legacy_delegate_coining_shares_operation, (delegator)(delegatee)(coining_shares) );
FC_REFLECT( voilk::plugins::condenser_api::legacy_author_reward_operation, (author)(permlink)(vsd_payout)(voilk_payout)(coining_payout) )
FC_REFLECT( voilk::plugins::condenser_api::legacy_curation_reward_operation, (curator)(reward)(comment_author)(comment_permlink) )
FC_REFLECT( voilk::plugins::condenser_api::legacy_comment_reward_operation, (author)(permlink)(payout) )
FC_REFLECT( voilk::plugins::condenser_api::legacy_fill_convert_request_operation, (owner)(requestid)(amount_in)(amount_out) )
FC_REFLECT( voilk::plugins::condenser_api::legacy_liquidity_reward_operation, (owner)(payout) )
FC_REFLECT( voilk::plugins::condenser_api::legacy_interest_operation, (owner)(interest) )
FC_REFLECT( voilk::plugins::condenser_api::legacy_fill_coining_withdraw_operation, (from_account)(to_account)(withdrawn)(deposited) )
FC_REFLECT( voilk::plugins::condenser_api::legacy_fill_order_operation, (current_owner)(current_orderid)(current_pays)(open_owner)(open_orderid)(open_pays) )
FC_REFLECT( voilk::plugins::condenser_api::legacy_fill_transfer_from_savings_operation, (from)(to)(amount)(request_id)(memo) )
FC_REFLECT( voilk::plugins::condenser_api::legacy_return_coining_delegation_operation, (account)(coining_shares) )
FC_REFLECT( voilk::plugins::condenser_api::legacy_comment_benefactor_reward_operation, (benefactor)(author)(permlink)(vsd_payout)(voilk_payout)(coining_payout) )
FC_REFLECT( voilk::plugins::condenser_api::legacy_producer_reward_operation, (producer)(coining_shares) )
FC_REFLECT( voilk::plugins::condenser_api::legacy_claim_account_operation, (creator)(fee)(extensions) )

FC_REFLECT_TYPENAME( voilk::plugins::condenser_api::legacy_operation )
