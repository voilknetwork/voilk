...
#include <voilk/plugins/tags_api/tags_api.hpp>
#include <voilk/plugins/follow_api/follow_api.hpp>
#include <voilk/plugins/reputation_api/reputation_api.hpp>
#include <voilk/plugins/market_history_api/market_history_api.hpp>
#include <voilk/plugins/witness_api/witness_api.hpp>

#include <voilk/plugins/condenser_api/condenser_api_legacy_objects.hpp>
...
struct api_account_object
{
   api_account_object( const database_api::api_account_object& a ) :
      ...
      vsd_balance( legacy_asset::from_asset( a.vsd_balance ) ),
      vsd_seconds( a.vsd_seconds ),
      vsd_seconds_last_update( a.vsd_seconds_last_update ),
      vsd_last_interest_payment( a.vsd_last_interest_payment ),
      savings_vsd_balance( legacy_asset::from_asset( a.savings_vsd_balance ) ),
      savings_vsd_seconds( a.savings_vsd_seconds ),
      savings_vsd_seconds_last_update( a.savings_vsd_seconds_last_update ),
      savings_vsd_last_interest_payment( a.savings_vsd_last_interest_payment ),
      savings_withdraw_requests( a.savings_withdraw_requests ),
      reward_vsd_balance( legacy_asset::from_asset( a.reward_vsd_balance ) ),
      reward_voilk_balance( legacy_asset::from_asset( a.reward_voilk_balance ) ),
      reward_coining_balance( legacy_asset::from_asset( a.reward_coining_balance ) ),
      reward_coining_voilk( legacy_asset::from_asset( a.reward_coining_voilk ) ),
   ...
   legacy_asset      vsd_balance;
   uint128_t         vsd_seconds;
   time_point_sec    vsd_seconds_last_update;
   time_point_sec    vsd_last_interest_payment;

   legacy_asset      savings_vsd_balance;
   uint128_t         savings_vsd_seconds;
   time_point_sec    savings_vsd_seconds_last_update;
   time_point_sec    savings_vsd_last_interest_payment;

   uint8_t           savings_withdraw_requests = 0;

   legacy_asset      reward_vsd_balance;
   legacy_asset      reward_voilk_balance;
   legacy_asset      reward_coining_balance;
   legacy_asset      reward_coining_voilk;
...
struct extended_account : public api_account_object
{
   ...
   legacy_asset                                             coining_balance;  /// convert coining_shares to coining voilk
...
struct api_comment_object
{
   api_comment_object( const database_api::api_comment_object& c ):
      ...
      percent_voilk_dollars( c.percent_voilk_dollars ),
   ...
   uint16_t          percent_voilk_dollars = 0;
...
struct extended_dynamic_global_properties
{
   ...
   extended_dynamic_global_properties( const database_api::api_dynamic_global_property_object& o ) :
      ...
      current_vsd_supply( legacy_asset::from_asset( o.current_vsd_supply ) ),
      confidential_vsd_supply( legacy_asset::from_asset( o.confidential_vsd_supply ) ),
      total_coining_fund_voilk( legacy_asset::from_asset( o.total_coining_fund_voilk ) ),
      total_coining_shares( legacy_asset::from_asset( o.total_coining_shares ) ),
      total_reward_fund_voilk( legacy_asset::from_asset( o.total_reward_fund_voilk ) ),
      ...
      pending_rewarded_coining_voilk( legacy_asset::from_asset( o.pending_rewarded_coining_voilk ) ),
      vsd_interest_rate( o.vsd_interest_rate ),
      vsd_print_rate( o.vsd_print_rate ),
      ...
      vsd_stop_percent( o.vsd_stop_percent ),
      vsd_start_percent( o.vsd_start_percent )
   {}
   ...
   legacy_asset      current_vsd_supply;
   legacy_asset      confidential_vsd_supply;
   legacy_asset      total_coining_fund_voilk;
   legacy_asset      total_coining_shares;
   legacy_asset      total_reward_fund_voilk;
   fc::uint128       total_reward_shares2;
   legacy_asset      pending_rewarded_coining_shares;
   legacy_asset      pending_rewarded_coining_voilk;
...
struct api_witness_object
{
   ...
   api_witness_object( const database_api::api_witness_object& w ) :
      ...
      props( w.props ),
      vsd_exchange_rate( w.vsd_exchange_rate ),
      last_vsd_exchange_update( w.last_vsd_exchange_update ),
      votes( w.votes ),
   ...
   legacy_price            vsd_exchange_rate;
   ...
   time_point_sec          hardfork_time_vote = VOILK_GENESIS_TIME;
...
struct api_witness_schedule_object
{
   ...
   uint8_t                       max_voted_witnesses           = VOILK_MAX_VOTED_WITNESSES_HF0;
   uint8_t                       max_miner_witnesses           = VOILK_MAX_MINER_WITNESSES_HF0;
   uint8_t                       max_runner_witnesses          = VOILK_MAX_RUNNER_WITNESSES_HF0;
   uint8_t                       hardfork_required_witnesses   = VOILK_HARDFORK_REQUIRED_WITNESSES;
...
struct api_escrow_object
{
   ...
   api_escrow_object( const database_api::api_escrow_object& e ) :
      ...
      vsd_balance( legacy_asset::from_asset( e.vsd_balance ) ),
      voilk_balance( legacy_asset::from_asset( e.voilk_balance ) ),
...
struct discussion : public api_comment_object
{
   ...
   string                        root_title;
   legacy_asset                  pending_payout_value; ///< vsd
   legacy_asset                  total_pending_payout_value; ///< vsd including replies
...
struct get_version_return
{
   ...
   get_version_return( fc::string bc_v, fc::string s_v, fc::string fc_v )
      :blockchain_version( bc_v ), voilk_revision( s_v ), fc_revision( fc_v ) {}

   fc::string blockchain_version;
   fc::string voilk_revision;
...
struct ticker
{
   ...
   ticker( const market_history::get_ticker_return& t ) :
      ...
      voilk_volume( legacy_asset::from_asset( t.voilk_volume ) ),
      vsd_volume( legacy_asset::from_asset( t.vsd_volume ) )
   {}
   ...
   legacy_asset   voilk_volume;
   legacy_asset   vsd_volume;
};
...
struct volume
{
   ...
   volume( const market_history::get_volume_return& v ) :
      voilk_volume( legacy_asset::from_asset( v.voilk_volume ) ),
      vsd_volume( legacy_asset::from_asset( v.vsd_volume ) )
   {}
...
FC_REFLECT( voilk::plugins::condenser_api::discussion_index,
...
FC_REFLECT( voilk::plugins::condenser_api::api_account_object,
             ...
             (reward_vsd_balance)(reward_voilk_balance)(reward_coining_balance)(reward_coining_voilk)
...
FC_REFLECT_DERIVED( voilk::plugins::condenser_api::extended_account, (voilk::plugins::condenser_api::api_account_object),
...
FC_REFLECT( voilk::plugins::condenser_api::api_comment_object,
             (id)(author)(permlink)
             ...
             (max_accepted_payout)(percent_voilk_dollars)(allow_replies)(allow_votes)(allow_curation_rewards)
             (beneficiaries)
          )

FC_REFLECT( voilk::plugins::condenser_api::extended_dynamic_global_properties,
            (head_block_number)(head_block_id)(time)
            (current_witness)(total_pow)(num_pow_witnesses)
            (virtual_supply)(current_supply)(confidential_supply)(current_vsd_supply)(confidential_vsd_supply)
            (total_coining_fund_voilk)(total_coining_shares)
            (total_reward_fund_voilk)(total_reward_shares2)(pending_rewarded_coining_shares)(pending_rewarded_coining_voilk)
            (vsd_interest_rate)(vsd_print_rate)
            ...
            (delegation_return_period)(reverse_auction_seconds)(vsd_stop_percent)(vsd_start_percent)
            (average_block_size)(current_reserve_ratio)(max_virtual_bandwidth) )

FC_REFLECT( voilk::plugins::condenser_api::api_witness_object,
             (id)
             (owner)
             (created)
             ...
             (props)
             (vsd_exchange_rate)(last_vsd_exchange_update)
             (last_work)
             (running_version)
...
FC_REFLECT( voilk::plugins::condenser_api::api_witness_schedule_object,
             (id)
...
FC_REFLECT( voilk::plugins::condenser_api::api_feed_history_object,
             (id)
             (current_median_history)
             (price_history)
          )

FC_REFLECT( voilk::plugins::condenser_api::api_reward_fund_object,
            (id)
            (name)
            (reward_balance)
            (recent_claims)
...
FC_REFLECT( voilk::plugins::condenser_api::api_escrow_object,
             (id)(escrow_id)(from)(to)(agent)
             (ratification_deadline)(escrow_expiration)
             (vsd_balance)(voilk_balance)(pending_fee)
             (to_approved)(agent_approved)(disputed) )

FC_REFLECT( voilk::plugins::condenser_api::api_savings_withdraw_object,
             (id)
             (from)
             (to)
             (memo)
...
FC_REFLECT( voilk::plugins::condenser_api::api_coining_delegation_object,
            (id)(delegator)(delegatee)(coining_shares)(min_delegation_time) )

FC_REFLECT( voilk::plugins::condenser_api::api_coining_delegation_expiration_object,
            (id)(delegator)(coining_shares)(expiration) )

FC_REFLECT( voilk::plugins::condenser_api::api_convert_request_object,
             (id)(owner)(requestid)(amount)(conversion_date) )

FC_REFLECT_DERIVED( voilk::plugins::condenser_api::discussion, (voilk::plugins::condenser_api::api_comment_object),
...
FC_REFLECT( voilk::plugins::condenser_api::scheduled_hardfork,
            (hf_version)(live_time) )

FC_REFLECT( voilk::plugins::condenser_api::account_vote,
            (authorperm)(weight)(rshares)(percent)(time) )

FC_REFLECT( voilk::plugins::condenser_api::tag_index, (trending) )

FC_REFLECT_ENUM( voilk::plugins::condenser_api::withdraw_route_type, (incoming)(outgoing)(all) )

FC_REFLECT( voilk::plugins::condenser_api::get_version_return,
            (blockchain_version)(voilk_revision)(fc_revision) )

FC_REFLECT( voilk::plugins::condenser_api::broadcast_transaction_synchronous_return,
            (id)(block_num)(trx_num)(expired) )

FC_REFLECT( voilk::plugins::condenser_api::comment_feed_entry,
            (comment)(reblog_by)(reblog_on)(entry_id) )

FC_REFLECT( voilk::plugins::condenser_api::comment_blog_entry,
            (comment)(blog)(reblog_on)(entry_id) )

FC_REFLECT( voilk::plugins::condenser_api::ticker,
            (latest)(lowest_ask)(highest_bid)(percent_change)(voilk_volume)(vsd_volume) )

FC_REFLECT( voilk::plugins::condenser_api::volume,
            (voilk_volume)(vsd_volume) )

FC_REFLECT( voilk::plugins::condenser_api::order,
            (order_price)(real_price)(voilk)(vsd)(created) )

FC_REFLECT( voilk::plugins::condenser_api::order_book,
            (bids)(asks) )

FC_REFLECT( voilk::plugins::condenser_api::market_trade,
