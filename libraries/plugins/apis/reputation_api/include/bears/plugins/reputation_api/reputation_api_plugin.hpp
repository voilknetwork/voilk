...
#define BEARS_REPUTATION_API_PLUGIN_NAME "reputation_api"
...
public:
   APPBASE_PLUGIN_REQUIRES(
      (bears::plugins::reputation::reputation_plugin)
   ...
   static const std::string& name() { static std::string name = BEARS_REPUTATION_API_PLUGIN_NAME; return name; }
