...
{
   voilk::chain::signed_block block;
...
typedef voilk::chain::signed_transaction push_transaction_args;
...
FC_REFLECT( voilk::plugins::chain::push_block_args, (block)(currently_syncing) )
FC_REFLECT( voilk::plugins::chain::push_block_return, (success)(error) )
FC_REFLECT( voilk::plugins::chain::push_transaction_return, (success)(error) )
