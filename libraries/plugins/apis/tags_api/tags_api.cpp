      ...
      namespace tags
      {
         ...
         namespace detail
         {
            ...
            public:
               ...
               chain::database &_db;
               std::shared_ptr<voilk::plugins::follow::follow_api> _follow_api;
            };
            ...
            DEFINE_API_IMPL(tags_api_impl, get_post_discussions_by_payout)
            {
               ...
               return get_discussions(
                   args, tag, parent, tidx, tidx_itr, args.truncate_body, [](const database_api::api_comment_object &c) { return c.net_rshares <= 0; }, exit_default, tag_exit_default, true);
            }
            ...
            DEFINE_API_IMPL(tags_api_impl, get_discussions_by_promoted)
            {
               ...
               auto tidx_itr = tidx.lower_bound(boost::make_tuple(tag, parent, share_type(VOILK_MAX_SHARE_SUPPLY)));
            ...
            void tags_api_impl::set_pending_payout(discussion &d)
            {
               ...
               {
                  d.promoted = asset(itr->promoted_balance, VSD_SYMBOL);
               }
                                                                   ...
                                                                   bool ignore_parent)
            {
               ...
               while (count > 0 && tidx_itr != tidx.end())
               {
                  ...
                  try
                  {
                     ...
                     result.discussions.back().promoted = asset(tidx_itr->promoted_balance, VSD_SYMBOL);
         ...
         {
            JSON_RPC_REGISTER_API(VOILK_TAGS_API_PLUGIN_NAME);
         }
         ...
         {
            auto follow_api_plugin = appbase::app().find_plugin<voilk::plugins::follow::follow_api_plugin>();
