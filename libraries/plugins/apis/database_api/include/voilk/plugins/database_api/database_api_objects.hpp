...
struct api_comment_object
{
   api_comment_object( const comment_object& o, const database& db ):
      ...
      percent_voilk_dollars( o.percent_voilk_dollars ),
...
struct api_account_object
{
   api_account_object( const account_object& a, const database& db ) :
      ...
      savings_vsd_balance( a.savings_vsd_balance ),
      ...
      reward_vsd_balance( a.reward_vsd_balance ),
      reward_voilk_balance( a.reward_voilk_balance ),
      reward_coining_balance( a.reward_coining_balance ),
      reward_coining_voilk( a.reward_coining_voilk ),
   ...
   asset             reward_vsd_balance;
   asset             reward_voilk_balance;
   asset             reward_coining_balance;
   asset             reward_coining_voilk;
...
{
   price                order_price;
   double               real_price; // dollars per voilk
   share_type           voilk;
   share_type           vsd;
...
FC_REFLECT( voilk::plugins::database_api::api_comment_object,
             (id)(author)(permlink)
...
FC_REFLECT( voilk::plugins::database_api::api_comment_vote_object,
             (id)(voter)(author)(permlink)(weight)(rshares)(vote_percent)(last_update)(num_changes)
          )

FC_REFLECT( voilk::plugins::database_api::api_account_object,
...
FC_REFLECT( voilk::plugins::database_api::api_owner_authority_history_object,
             (id)
             (account)
...
FC_REFLECT( voilk::plugins::database_api::api_account_recovery_request_object,
             (id)
             (account_to_recover)
             (new_owner_authority)
             (expires)
...
FC_REFLECT( voilk::plugins::database_api::api_savings_withdraw_object,
             (id)
             (from)
             (to)
             (memo)
...
FC_REFLECT( voilk::plugins::database_api::api_feed_history_object,
             (id)
             (current_median_history)
             (price_history)
          )

FC_REFLECT( voilk::plugins::database_api::api_witness_object,
             (id)
             (owner)
             (created)
...
FC_REFLECT( voilk::plugins::database_api::api_witness_schedule_object,
             (id)
...
FC_REFLECT_DERIVED( voilk::plugins::database_api::api_signed_block_object, (voilk::protocol::signed_block),
                     (block_id)
                     (signing_key)
                     (transaction_ids)
                  )

FC_REFLECT( voilk::plugins::database_api::api_hardfork_property_object,
            (id)
            (processed_hardforks)
            (last_hardfork)
...
FC_REFLECT( voilk::plugins::database_api::order, (order_price)(real_price)(voilk)(vsd)(created) );

FC_REFLECT( voilk::plugins::database_api::order_book, (asks)(bids) );
