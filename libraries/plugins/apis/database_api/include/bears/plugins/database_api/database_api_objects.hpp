...
typedef withdraw_coining_route_object          api_withdraw_coining_route_object;
...
typedef coining_delegation_object              api_coining_delegation_object;
typedef coining_delegation_expiration_object   api_coining_delegation_expiration_object;
...
struct api_comment_object
{
   api_comment_object( const comment_object& o, const database& db ):
      ...
      percent_bears_dollars( o.percent_bears_dollars ),
...
struct api_account_object
{
   api_account_object( const account_object& a, const database& db ) :
      ...
      savings_bsd_balance( a.savings_bsd_balance ),
      ...
      reward_bsd_balance( a.reward_bsd_balance ),
      reward_bears_balance( a.reward_bears_balance ),
      reward_coining_balance( a.reward_coining_balance ),
      reward_coining_bears( a.reward_coining_bears ),
      curation_rewards( a.curation_rewards ),
      posting_rewards( a.posting_rewards ),
      coining_shares( a.coining_shares ),
      delegated_coining_shares( a.delegated_coining_shares ),
      received_coining_shares( a.received_coining_shares ),
      coining_withdraw_rate( a.coining_withdraw_rate ),
   ...
   asset             reward_bsd_balance;
   asset             reward_bears_balance;
   asset             reward_coining_balance;
   asset             reward_coining_bears;

   share_type        curation_rewards;
   share_type        posting_rewards;

   asset             coining_shares;
   asset             delegated_coining_shares;
   asset             received_coining_shares;
   asset             coining_withdraw_rate;
...
{
   price                order_price;
   double               real_price; // dollars per bears
   share_type           bears;
   share_type           bsd;
...
FC_REFLECT( bears::plugins::database_api::api_comment_object,
             (id)(author)(permlink)
...
FC_REFLECT( bears::plugins::database_api::api_comment_vote_object,
             (id)(voter)(author)(permlink)(weight)(rshares)(vote_percent)(last_update)(num_changes)
          )

FC_REFLECT( bears::plugins::database_api::api_account_object,
...
FC_REFLECT( bears::plugins::database_api::api_owner_authority_history_object,
             (id)
             (account)
...
FC_REFLECT( bears::plugins::database_api::api_account_recovery_request_object,
             (id)
             (account_to_recover)
             (new_owner_authority)
             (expires)
...
FC_REFLECT( bears::plugins::database_api::api_savings_withdraw_object,
             (id)
             (from)
             (to)
             (memo)
...
FC_REFLECT( bears::plugins::database_api::api_feed_history_object,
             (id)
             (current_median_history)
             (price_history)
          )

FC_REFLECT( bears::plugins::database_api::api_witness_object,
             (id)
             (owner)
             (created)
...
FC_REFLECT( bears::plugins::database_api::api_witness_schedule_object,
             (id)
...
FC_REFLECT_DERIVED( bears::plugins::database_api::api_signed_block_object, (bears::protocol::signed_block),
                     (block_id)
                     (signing_key)
                     (transaction_ids)
                  )

FC_REFLECT( bears::plugins::database_api::api_hardfork_property_object,
            (id)
            (processed_hardforks)
            (last_hardfork)
...
FC_REFLECT( bears::plugins::database_api::order, (order_price)(real_price)(bears)(bsd)(created) );

FC_REFLECT( bears::plugins::database_api::order_book, (asks)(bids) );
