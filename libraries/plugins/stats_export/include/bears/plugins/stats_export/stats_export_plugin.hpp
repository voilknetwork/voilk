...
#define BEARS_STATS_EXPORT_PLUGIN_NAME "stats_export"
...
class stats_export_plugin : public appbase::plugin< stats_export_plugin >
{
   public:
      ...
      APPBASE_PLUGIN_REQUIRES(
         (bears::plugins::block_data_export::block_data_export_plugin)
         (bears::plugins::chain::chain_plugin)
      )

      static const std::string& name() { static std::string name = BEARS_STATS_EXPORT_PLUGIN_NAME; return name; }
