#pragma once
#include <voilk/plugins/statsd/statsd_plugin.hpp>
...
using voilk::plugins::statsd::statsd_plugin;
...
if( voilk::plugins::statsd::util::statsd_enabled() )     \
{                                                        \
   voilk::plugins::statsd::util::get_statsd().increment( \
...
if( voilk::plugins::statsd::util::statsd_enabled() )     \
{                                                        \
   voilk::plugins::statsd::util::get_statsd().decrement( \
      NAMESPACE, STAT, KEY, FREQ                         \
   );                                                    \
}
...
if( voilk::plugins::statsd::util::statsd_enabled() )     \
{                                                        \
   voilk::plugins::statsd::util::get_statsd().count(     \
...
if( voilk::plugins::statsd::util::statsd_enabled() )     \
{                                                        \
   voilk::plugins::statsd::util::get_statsd().gauge(     \
      NAMESPACE, STAT, KEY, VAL, FREQ                    \
   );                                                    \
}
...
fc::optional< voilk::plugins::statsd::util::statsd_timer_helper > statsd_timer;  \
if( voilk::plugins::statsd::util::statsd_enabled() )                             \
{                                                                                \
   statsd_timer = voilk::plugins::statsd::util::statsd_timer_helper(             \
      NAMESPACE, STAT, KEY, FREQ, voilk::plugins::statsd::util::get_statsd()     \
   );                                                                            \
}
...
if( voilk::plugins::statsd::util::statsd_enabled() )     \
{                                                        \
   voilk::plugins::statsd::util::get_statsd().timing(    \
      NAMESPACE, STAT, KEY,                              \
      voilk::plugins::statsd::util::timing_helper( VAL ),\
      FREQ                                               \
   );                                                    \
}
