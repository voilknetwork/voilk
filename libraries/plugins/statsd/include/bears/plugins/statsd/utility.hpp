...
using bears::plugins::statsd::statsd_plugin;
...
if( bears::plugins::statsd::util::statsd_enabled() )     \
{                                                        \
   bears::plugins::statsd::util::get_statsd().increment( \
...
if( bears::plugins::statsd::util::statsd_enabled() )     \
{                                                        \
   bears::plugins::statsd::util::get_statsd().decrement( \
      NAMESPACE, STAT, KEY, FREQ                         \
   );                                                    \
}
...
if( bears::plugins::statsd::util::statsd_enabled() )     \
{                                                        \
   bears::plugins::statsd::util::get_statsd().count(     \
...
if( bears::plugins::statsd::util::statsd_enabled() )     \
{                                                        \
   bears::plugins::statsd::util::get_statsd().gauge(     \
      NAMESPACE, STAT, KEY, VAL, FREQ                    \
   );                                                    \
}
...
fc::optional< bears::plugins::statsd::util::statsd_timer_helper > statsd_timer;  \
if( bears::plugins::statsd::util::statsd_enabled() )                             \
{                                                                                \
   statsd_timer = bears::plugins::statsd::util::statsd_timer_helper(             \
      NAMESPACE, STAT, KEY, FREQ, bears::plugins::statsd::util::get_statsd()     \
   );                                                                            \
}
...
if( bears::plugins::statsd::util::statsd_enabled() )     \
{                                                        \
   bears::plugins::statsd::util::get_statsd().timing(    \
      NAMESPACE, STAT, KEY,                              \
      bears::plugins::statsd::util::timing_helper( VAL ),\
      FREQ                                               \
   );                                                    \
}
