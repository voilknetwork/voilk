...
struct private_message_operation : public voilk::protocol::base_operation
{
...
FC_REFLECT( voilk::private_message::private_message_operation, (from)(to)(from_memo_key)(to_memo_key)(sent_time)(checksum)(encrypted_message) )

VOILK_DECLARE_OPERATION_TYPE( voilk::private_message::private_message_plugin_operation )
FC_REFLECT_TYPENAME( voilk::private_message::private_message_plugin_operation )
