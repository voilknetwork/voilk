...
// time.
//
#ifndef BEARS_BLOCKCHAIN_STATISTICS_SPACE_ID
#define BEARS_BLOCKCHAIN_STATISTICS_SPACE_ID 9
#endif

#ifndef BEARS_BLOCKCHAIN_STATISTICS_PLUGIN_NAME
#define BEARS_BLOCKCHAIN_STATISTICS_PLUGIN_NAME "chain_stats"
#endif
...
{
   bucket_object_type = ( BEARS_BLOCKCHAIN_STATISTICS_SPACE_ID << 8 )
};
...
class blockchain_statistics_plugin : public bears::app::plugin
{
   public:
      blockchain_statistics_plugin( application* app );
      virtual ~blockchain_statistics_plugin();

      virtual std::string plugin_name()const override { return BEARS_BLOCKCHAIN_STATISTICS_PLUGIN_NAME; }
...
struct bucket_object : public object< bucket_object_type, bucket_object >
{
   ...
   share_type           bears_transferred = 0;                       ///< BEARS transferred from account to account
   ...
   share_type           liquidity_rewards_paid = 0;                  ///< Ammount of BEARS paid to market makers
   uint32_t             transfers_to_coining = 0;                    ///< Transfers of BEARS into COINS
   share_type           bears_coined = 0;                            ///< Ammount of BEARS coined
   ...
   share_type           coins_withdrawn = 0;                         ///< Ammount of COINS withdrawn to BEARS
...
FC_REFLECT( bears::blockchain_statistics::bucket_object,
   (id)
   (open)
   (seconds)
   (blocks)
...
CHAINBASE_SET_INDEX_TYPE( bears::blockchain_statistics::bucket_object, bears::blockchain_statistics::bucket_index )
