...
namespace voilk { namespace protocol {
   ...
   struct author_reward_operation : public virtual_operation {
      ...
      author_reward_operation( const account_name_type& a, const string& p, const asset& s, const asset& st, const asset& v )
         :author(a), permlink(p), vsd_payout(s), voilk_payout(st), coining_payout(v){}

      account_name_type author;
      string            permlink;
      asset             vsd_payout;
      asset             voilk_payout;
      asset             coining_payout;
   };
   ...
   {
      interest_operation( const string& o = "", const asset& i = asset(0,VSD_SYMBOL) )
         :owner(o),interest(i){}
   ...
   struct fill_coining_withdraw_operation : public virtual_operation
   {
      fill_coining_withdraw_operation(){}
      fill_coining_withdraw_operation( const string& f, const string& t, const asset& w, const asset& d )
   ...
   struct return_coining_delegation_operation : public virtual_operation
   {
      return_coining_delegation_operation() {}
      return_coining_delegation_operation( const account_name_type& a, const asset& v ) : account( a ), coining_shares( v ) {}
   ...
   struct comment_benefactor_reward_operation : public virtual_operation
   {
      ...
      comment_benefactor_reward_operation( const account_name_type& b, const account_name_type& a, const string& p, const asset& s, const asset& st, const asset& v )
         : benefactor( b ), author( a ), permlink( p ), vsd_payout( s ), voilk_payout( st ), coining_payout( v ) {}
   ...
   struct producer_reward_operation : public virtual_operation
   {
      ...
      producer_reward_operation( const string& p, const asset& v ) : producer( p ), coining_shares( v ) {}
...
FC_REFLECT( voilk::protocol::author_reward_operation, (author)(permlink)(vsd_payout)(voilk_payout)(coining_payout) )
FC_REFLECT( voilk::protocol::curation_reward_operation, (curator)(reward)(comment_author)(comment_permlink) )
FC_REFLECT( voilk::protocol::comment_reward_operation, (author)(permlink)(payout) )
FC_REFLECT( voilk::protocol::fill_convert_request_operation, (owner)(requestid)(amount_in)(amount_out) )
FC_REFLECT( voilk::protocol::liquidity_reward_operation, (owner)(payout) )
FC_REFLECT( voilk::protocol::interest_operation, (owner)(interest) )
FC_REFLECT( voilk::protocol::fill_coining_withdraw_operation, (from_account)(to_account)(withdrawn)(deposited) )
FC_REFLECT( voilk::protocol::shutdown_witness_operation, (owner) )
FC_REFLECT( voilk::protocol::fill_order_operation, (current_owner)(current_orderid)(current_pays)(open_owner)(open_orderid)(open_pays) )
FC_REFLECT( voilk::protocol::fill_transfer_from_savings_operation, (from)(to)(amount)(request_id)(memo) )
FC_REFLECT( voilk::protocol::hardfork_operation, (hardfork_id) )
FC_REFLECT( voilk::protocol::comment_payout_update_operation, (author)(permlink) )
FC_REFLECT( voilk::protocol::return_coining_delegation_operation, (account)(coining_shares) )
FC_REFLECT( voilk::protocol::comment_benefactor_reward_operation, (benefactor)(author)(permlink)(vsd_payout)(voilk_payout)(coining_payout) )
FC_REFLECT( voilk::protocol::producer_reward_operation, (producer)(coining_shares) )
FC_REFLECT( voilk::protocol::clear_null_account_balance_operation, (total_cleared) )
