...
#include <voilk/protocol/optional_automated_actions.hpp>
...
FC_REFLECT_TYPENAME( voilk::protocol::block_header_extensions )

FC_REFLECT( voilk::protocol::block_header, (previous)(timestamp)(witness)(transaction_merkle_root)(extensions) )
FC_REFLECT_DERIVED( voilk::protocol::signed_block_header, (voilk::protocol::block_header), (witness_signature) )
