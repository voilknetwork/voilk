...
#include <voilk/protocol/voilk_virtual_operations.hpp>
...
/*namespace fc {
    void to_variant( const voilk::protocol::operation& var,  fc::variant& vo );
    void from_variant( const fc::variant& var,  voilk::protocol::operation& vo );
}*/

VOILK_DECLARE_OPERATION_TYPE( voilk::protocol::operation )
FC_REFLECT_TYPENAME( voilk::protocol::operation )
