 ...
 * - Length is between (inclusive) VOILK_MIN_ACCOUNT_NAME_LENGTH and VOILK_MAX_ACCOUNT_NAME_LENGTH
 */
bool is_valid_account_name( const string& name );

bool operator == ( const authority& a, const authority& b );

} } // namespace voilk::protocol


FC_REFLECT_TYPENAME( voilk::protocol::authority::account_authority_map)
FC_REFLECT_TYPENAME( voilk::protocol::authority::key_authority_map)
FC_REFLECT( voilk::protocol::authority, (weight_threshold)(account_auths)(key_auths) )
FC_REFLECT_ENUM( voilk::protocol::authority::classification, (owner)(active)(key)(posting) )
