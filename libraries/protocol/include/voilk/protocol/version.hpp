...
/*
 * This class represents the basic versioning scheme of the Voilk blockchain.
...
{
   class variant;
   void to_variant( const voilk::protocol::version& v, variant& var );
   void from_variant( const variant& var, voilk::protocol::version& v );

   void to_variant( const voilk::protocol::hardfork_version& hv, variant& var );
   void from_variant( const variant& var, voilk::protocol::hardfork_version& hv );
} // fc

#include <fc/reflect/reflect.hpp>
FC_REFLECT( voilk::protocol::version, (v_num) )
FC_REFLECT_DERIVED( voilk::protocol::hardfork_version, (voilk::protocol::version), )

FC_REFLECT( voilk::protocol::hardfork_version_vote, (hf_version)(hf_time) )
