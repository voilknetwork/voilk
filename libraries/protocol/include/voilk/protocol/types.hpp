...
#include <voilk/protocol/fixed_string.hpp>
...
namespace voilk {
   ...
   namespace protocol {
      ...
      #define VOILK_INIT_PUBLIC_KEY (voilk::protocol::public_key_type(VOILK_INIT_PUBLIC_KEY_STR))
...
namespace fc
{
    void to_variant( const voilk::protocol::public_key_type& var,  fc::variant& vo );
    void from_variant( const fc::variant& var,  voilk::protocol::public_key_type& vo );
    void to_variant( const voilk::protocol::extended_public_key_type& var, fc::variant& vo );
    void from_variant( const fc::variant& var, voilk::protocol::extended_public_key_type& vo );
    void to_variant( const voilk::protocol::extended_private_key_type& var, fc::variant& vo );
    void from_variant( const fc::variant& var, voilk::protocol::extended_private_key_type& vo );
}

FC_REFLECT( voilk::protocol::public_key_type, (key_data) )
FC_REFLECT( voilk::protocol::public_key_type::binary_key, (data)(check) )
FC_REFLECT( voilk::protocol::extended_public_key_type, (key_data) )
FC_REFLECT( voilk::protocol::extended_public_key_type::binary_key, (check)(data) )
FC_REFLECT( voilk::protocol::extended_private_key_type, (key_data) )
FC_REFLECT( voilk::protocol::extended_private_key_type::binary_key, (check)(data) )

FC_REFLECT_TYPENAME( voilk::protocol::share_type )

FC_REFLECT( voilk::void_t, )
