...
//
// Place BEARS_DEFINE_OPERATION_TYPE in a .cpp file to define
// functions related to your operation type
//
#define BEARS_DEFINE_OPERATION_TYPE( OperationType )                       \
                                                                           \
namespace bears { namespace protocol {                                     \
                                                                           \
void operation_validate( const OperationType& op )                         \
{                                                                          \
   op.visit( bears::protocol::operation_validate_visitor() );              \
}                                                                          \
                                                                           \
...
{                                                                          \
   op.visit( bears::protocol::get_required_auth_visitor( active, owner, posting, other ) ); \
}                                                                          \
                                                                           \
} } /* bears::protocol */
