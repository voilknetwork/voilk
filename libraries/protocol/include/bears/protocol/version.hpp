...
/*
 * This class represents the basic versioning scheme of the Bears blockchain.
...
{
   class variant;
   void to_variant( const bears::protocol::version& v, variant& var );
   void from_variant( const variant& var, bears::protocol::version& v );

   void to_variant( const bears::protocol::hardfork_version& hv, variant& var );
   void from_variant( const variant& var, bears::protocol::hardfork_version& hv );
} // fc

#include <fc/reflect/reflect.hpp>
FC_REFLECT( bears::protocol::version, (v_num) )
FC_REFLECT_DERIVED( bears::protocol::hardfork_version, (bears::protocol::version), )

FC_REFLECT( bears::protocol::hardfork_version_vote, (hf_version)(hf_time) )
