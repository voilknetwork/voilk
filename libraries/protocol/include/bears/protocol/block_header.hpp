...
#include <bears/protocol/optional_automated_actions.hpp>
...
FC_REFLECT_TYPENAME( bears::protocol::block_header_extensions )

FC_REFLECT( bears::protocol::block_header, (previous)(timestamp)(witness)(transaction_merkle_root)(extensions) )
FC_REFLECT_DERIVED( bears::protocol::signed_block_header, (bears::protocol::block_header), (witness_signature) )
