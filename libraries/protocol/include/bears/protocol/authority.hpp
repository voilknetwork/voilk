 ...
 * - Length is between (inclusive) BEARS_MIN_ACCOUNT_NAME_LENGTH and BEARS_MAX_ACCOUNT_NAME_LENGTH
 */
bool is_valid_account_name( const string& name );

bool operator == ( const authority& a, const authority& b );

} } // namespace bears::protocol


FC_REFLECT_TYPENAME( bears::protocol::authority::account_authority_map)
FC_REFLECT_TYPENAME( bears::protocol::authority::key_authority_map)
FC_REFLECT( bears::protocol::authority, (weight_threshold)(account_auths)(key_auths) )
FC_REFLECT_ENUM( bears::protocol::authority::classification, (owner)(active)(key)(posting) )
