...
#include <bears/protocol/bears_virtual_operations.hpp>
...
/*namespace fc {
    void to_variant( const bears::protocol::operation& var,  fc::variant& vo );
    void from_variant( const fc::variant& var,  bears::protocol::operation& vo );
}*/

BEARS_DECLARE_OPERATION_TYPE( bears::protocol::operation )
FC_REFLECT_TYPENAME( bears::protocol::operation )
