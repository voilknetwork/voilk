...
#include <bears/protocol/fixed_string.hpp>
...
namespace bears {
   ...
   namespace protocol {
      ...
      #define BEARS_INIT_PUBLIC_KEY (bears::protocol::public_key_type(BEARS_INIT_PUBLIC_KEY_STR))
...
namespace fc
{
    void to_variant( const bears::protocol::public_key_type& var,  fc::variant& vo );
    void from_variant( const fc::variant& var,  bears::protocol::public_key_type& vo );
    void to_variant( const bears::protocol::extended_public_key_type& var, fc::variant& vo );
    void from_variant( const fc::variant& var, bears::protocol::extended_public_key_type& vo );
    void to_variant( const bears::protocol::extended_private_key_type& var, fc::variant& vo );
    void from_variant( const fc::variant& var, bears::protocol::extended_private_key_type& vo );
}

FC_REFLECT( bears::protocol::public_key_type, (key_data) )
FC_REFLECT( bears::protocol::public_key_type::binary_key, (data)(check) )
FC_REFLECT( bears::protocol::extended_public_key_type, (key_data) )
FC_REFLECT( bears::protocol::extended_public_key_type::binary_key, (check)(data) )
FC_REFLECT( bears::protocol::extended_private_key_type, (key_data) )
FC_REFLECT( bears::protocol::extended_private_key_type::binary_key, (check)(data) )

FC_REFLECT_TYPENAME( bears::protocol::share_type )

FC_REFLECT( bears::void_t, )
