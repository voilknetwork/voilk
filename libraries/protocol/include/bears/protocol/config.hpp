...
#define BEARS_COINING_WITHDRAW_INTERVALS      365
#define BEARS_COINING_WITHDRAW_INTERVAL_SECONDS (60*60*24) /// 1 day per interval
...
#define BEARS_BSD_INTEREST_COMPOUND_INTERVAL_SEC  (60)// for testing changed to 1 minute (60*60*24*30) 
...
#define BEARS_FEED_INTERVAL_BLOCKS            (BEARS_BLOCKS_PER_HOUR/12) // Update every 100 blocks 
...
#define BEARS_MIN_FEEDS                       (1)//BEARS_MAX_WITNESSES/7) 1 witness enough to publish feed
...
#define BEARS_INITIAL_VOTE_POWER_RATE (10)
