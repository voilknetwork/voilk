...
#define BEARS_APR_PERCENT_MULTIPLY_PER_BLOCK ((uint64_t(0x5ccc) << 0x20) | (uint64_t(0xe802) << 0x10) | (uint64_t(0xde5f)))
...
#define BEARS_APR_PERCENT_MULTIPLY_PER_ROUND ((uint64_t(0x79cc) << 0x20) | (uint64_t(0xf5c7) << 0x10) | (uint64_t(0x3480)))
...
#define BEARS_APR_PERCENT_MULTIPLY_PER_HOUR ((uint64_t(0x6cc1) << 0x20) | (uint64_t(0x39a1) << 0x10) | (uint64_t(0x5cbd)))
...
#define BEARS_MIN_FEEDS (BEARS_MAX_WITNESSES / 7)              /// 7 Witnesses to publish feed..  protects the network from conversions before price has been established
