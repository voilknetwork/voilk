...
namespace bears { namespace protocol {
    ...
    *  @see SMT spec for details: https://github.com/bearshares/smt-whitepaper/blob/master/smt-manual/manual.md
    */
   struct allowed_vote_assets
   {
      ...
      void validate() const
      {
         ...
         FC_ASSERT(is_allowed(BEARS_SYMBOL) == false,
            "BEARS can not be explicitly specified as one of allowed_vote_assets");
      }
    ...
    *  The percent_bears_dollars may be decreased, but never increased
    *
    */
   struct comment_options_operation : public base_operation
   {
      ...
      asset             max_accepted_payout    = asset( 1000000000, BSD_SYMBOL );       /// BSD value of the maximum payout this post will receive
      uint16_t          percent_bears_dollars  = BEARS_100_PERCENT; /// the percent of Bears Dollars to key, unkept amounts will be received as Bears Power
    ...
    * @ingroup operations
    *
    * @brief Transfers BEARS from one account to another.
    */
   ...
   struct escrow_transfer_operation : public base_operation
   {
      ...
      asset             bsd_amount = asset( 0, BSD_SYMBOL );
      asset             bears_amount = asset( 0, BEARS_SYMBOL );
      asset             fee;
   ...
   struct escrow_release_operation : public base_operation
   {
      ...
      uint32_t          escrow_id = 30;
      asset             bsd_amount = asset( 0, BSD_SYMBOL ); ///< the amount of bsd to release
      asset             bears_amount = asset( 0, BEARS_SYMBOL ); ///< the amount of bears to release
   ...
   /**
    *  This operation converts liquid token (BEARS or liquid SMT) into VFS (Coining Fund Shares,
    *  COINS or coining SMT) at the current exchange rate. With this operation it is possible to
    *  give another account coining shares so that faucets can pre-fund new accounts with coining shares.
    */
   struct transfer_to_coining_operation : public base_operation
   {
      account_name_type from;
      account_name_type to;      ///< if null, then same as from
      asset             amount;  ///< must be BEARS or liquid variant of SMT
    ...
    * coining shares. A user may change the number of shares they wish to
    * cash out at any time between 0 and their total coining stake.
    *
    * After applying this operation, coining_shares will be withdrawn
    * at a rate of coining_shares/104 per week for two years starting
    * one week after this operation is included in the blockchain.
    *
    * This operation is not valid if the user has no coining shares.
    */
   struct withdraw_coining_operation : public base_operation
   {
      account_name_type account;
   ...
   /**
    * Allows an account to setup a coining withdraw but with the additional
    * request for the funds to be transferred directly to another account's
    * balance rather than the withdrawing account. In addition, those funds
    * can be immediately coined again, circumventing the conversion from
    * coins to bears and back, guaranteeing they maintain their value.
    */
   struct set_withdraw_coining_route_operation : public base_operation
   {
      account_name_type from_account;
      account_name_type to_account;
      uint16_t          percent = 0;
      bool              auto_coin = false;
   ...
   {
      /**
       *  This fee, paid in BEARS, is converted into COINING SHARES for the new account. Accounts
       *  without coining shares cannot earn usage rations and therefore are powerless. This minimum
       *  fee requires all accounts to have some kind of commitment to the network that includes the
       *  ability to vote and make transactions.
       */
      legacy_bears_asset account_creation_fee = legacy_bears_asset::from_amount( BEARS_MIN_ACCOUNT_CREATION_FEE );
      ...
      void validate()const
      {
         ...
         FC_ASSERT( account_creation_fee.amount >= BEARS_MIN_ACCOUNT_CREATION_FEE);
         FC_ASSERT( maximum_block_size >= BEARS_MIN_BLOCK_SIZE_LIMIT);
         FC_ASSERT( bsd_interest_rate >= 0 );
         FC_ASSERT( bsd_interest_rate <= BEARS_100_PERCENT );
      }
   };
   ...
   struct witness_set_properties_operation : public base_operation
   {
      ...
      void get_required_authorities( vector< authority >& a )const
      {
         ...
         if( key_itr != props.end() )
         {
            ...
            a.push_back( authority( 1, BEARS_NULL_ACCOUNT, 1 ) ); // The null account auth is impossible to satisfy
      }
   };
    ...
    *  used to define the exchange rate between bears and the dollar.
    */
   ...
   /**
    *  This operation instructs the blockchain to start a conversion between BEARS and BSD,
    *  The funds are deposited after BEARS_CONVERSION_DELAY
    */
    ...
    * BEARS_MAX_WITNESSES blocks of the head block (1 round) and the
    * producer must be in the ACTIVE witness set.
    *
    * Users not in the ACTIVE witness set should not have to worry about their
    * key getting compromised and being used to produced multiple blocks so
    * the attacker can report it and steel their coining bears.
    *
    * The result of the operation is to transfer the full COINING BEARS balance
   ...
   /**
    * Delegate coining shares from one account to the other. The coining shares are still owned
    * by the original account, but content voting rights and bandwidth allocation are transferred
    * to the receiving account. This sets the delegation to `coining_shares`, increasing it or
    * decreasing it as needed. (i.e. a delegation of 0 removes the delegation)
    *
    * When a delegation is removed the shares are placed in limbo for a week to prevent a satoshi
    * of COINS from voting on the same content twice.
    */
   struct delegate_coining_shares_operation : public base_operation
   {
      account_name_type delegator;        ///< The account delegating coining shares
      account_name_type delegatee;        ///< The account receiving coining shares
      asset             coining_shares;   ///< The amount of coining shares delegated
...
FC_REFLECT( bears::protocol::transfer_to_savings_operation, (from)(to)(amount)(memo) )
FC_REFLECT( bears::protocol::transfer_from_savings_operation, (from)(request_id)(to)(amount)(memo) )
FC_REFLECT( bears::protocol::cancel_transfer_from_savings_operation, (from)(request_id) )

FC_REFLECT( bears::protocol::reset_account_operation, (reset_account)(account_to_reset)(new_owner_authority) )
FC_REFLECT( bears::protocol::set_reset_account_operation, (account)(current_reset_account)(reset_account) )


FC_REFLECT( bears::protocol::report_over_production_operation, (reporter)(first_block)(second_block) )
FC_REFLECT( bears::protocol::convert_operation, (owner)(requestid)(amount) )
FC_REFLECT( bears::protocol::feed_publish_operation, (publisher)(exchange_rate) )
FC_REFLECT( bears::protocol::pow, (worker)(input)(signature)(work) )
FC_REFLECT( bears::protocol::pow2, (input)(pow_summary) )
FC_REFLECT( bears::protocol::pow2_input, (worker_account)(prev_block)(nonce) )
FC_REFLECT( bears::protocol::equihash_pow, (input)(proof)(prev_block)(pow_summary) )
FC_REFLECT( bears::protocol::legacy_chain_properties,
            (account_creation_fee)
            (maximum_block_size)
            (bsd_interest_rate)
          )

FC_REFLECT_TYPENAME( bears::protocol::pow2_work )
FC_REFLECT( bears::protocol::pow_operation, (worker_account)(block_id)(nonce)(work)(props) )
FC_REFLECT( bears::protocol::pow2_operation, (work)(new_owner_key)(props) )

FC_REFLECT( bears::protocol::account_create_operation,
            (fee)
            (creator)
            (new_account_name)
            (owner)
...
FC_REFLECT( bears::protocol::account_create_with_delegation_operation,
            (fee)
            (delegation)
            (creator)
            (new_account_name)
...
FC_REFLECT( bears::protocol::account_update_operation,
            (account)
            (owner)
            (active)
            (posting)
...
FC_REFLECT( bears::protocol::transfer_operation, (from)(to)(amount)(memo) )
FC_REFLECT( bears::protocol::transfer_to_coining_operation, (from)(to)(amount) )
FC_REFLECT( bears::protocol::withdraw_coining_operation, (account)(coining_shares) )
FC_REFLECT( bears::protocol::set_withdraw_coining_route_operation, (from_account)(to_account)(percent)(auto_coin) )
FC_REFLECT( bears::protocol::witness_update_operation, (owner)(url)(block_signing_key)(props)(fee) )
FC_REFLECT( bears::protocol::witness_set_properties_operation, (owner)(props)(extensions) )
FC_REFLECT( bears::protocol::account_witness_vote_operation, (account)(witness)(approve) )
FC_REFLECT( bears::protocol::account_witness_proxy_operation, (account)(proxy) )
FC_REFLECT( bears::protocol::comment_operation, (parent_author)(parent_permlink)(author)(permlink)(title)(body)(json_metadata) )
FC_REFLECT( bears::protocol::vote_operation, (voter)(author)(permlink)(weight) )
FC_REFLECT( bears::protocol::custom_operation, (required_auths)(id)(data) )
FC_REFLECT( bears::protocol::custom_json_operation, (required_auths)(required_posting_auths)(id)(json) )
FC_REFLECT( bears::protocol::custom_binary_operation, (required_owner_auths)(required_active_auths)(required_posting_auths)(required_auths)(id)(data) )
FC_REFLECT( bears::protocol::limit_order_create_operation, (owner)(orderid)(amount_to_sell)(min_to_receive)(fill_or_kill)(expiration) )
FC_REFLECT( bears::protocol::limit_order_create2_operation, (owner)(orderid)(amount_to_sell)(exchange_rate)(fill_or_kill)(expiration) )
FC_REFLECT( bears::protocol::limit_order_cancel_operation, (owner)(orderid) )

FC_REFLECT( bears::protocol::delete_comment_operation, (author)(permlink) );

FC_REFLECT( bears::protocol::beneficiary_route_type, (account)(weight) )
FC_REFLECT( bears::protocol::comment_payout_beneficiaries, (beneficiaries) )

#ifdef BEARS_ENABLE_SMT
FC_REFLECT( bears::protocol::votable_asset_info_v1, (max_accepted_payout)(allow_curation_rewards) )
FC_REFLECT( bears::protocol::allowed_vote_assets, (votable_assets) )
#endif

FC_REFLECT_TYPENAME( bears::protocol::comment_options_extension )
FC_REFLECT( bears::protocol::comment_options_operation, (author)(permlink)(max_accepted_payout)(percent_bears_dollars)(allow_votes)(allow_curation_rewards)(extensions) )

FC_REFLECT( bears::protocol::escrow_transfer_operation, (from)(to)(bsd_amount)(bears_amount)(escrow_id)(agent)(fee)(json_meta)(ratification_deadline)(escrow_expiration) );
FC_REFLECT( bears::protocol::escrow_approve_operation, (from)(to)(agent)(who)(escrow_id)(approve) );
FC_REFLECT( bears::protocol::escrow_dispute_operation, (from)(to)(agent)(who)(escrow_id) );
FC_REFLECT( bears::protocol::escrow_release_operation, (from)(to)(agent)(who)(receiver)(escrow_id)(bsd_amount)(bears_amount) );
FC_REFLECT( bears::protocol::claim_account_operation, (creator)(fee)(extensions) );
FC_REFLECT( bears::protocol::create_claimed_account_operation, (creator)(new_account_name)(owner)(active)(posting)(memo_key)(json_metadata)(extensions) );
FC_REFLECT( bears::protocol::request_account_recovery_operation, (recovery_account)(account_to_recover)(new_owner_authority)(extensions) );
FC_REFLECT( bears::protocol::recover_account_operation, (account_to_recover)(new_owner_authority)(recent_owner_authority)(extensions) );
FC_REFLECT( bears::protocol::change_recovery_account_operation, (account_to_recover)(new_recovery_account)(extensions) );
FC_REFLECT( bears::protocol::decline_voting_rights_operation, (account)(decline) );
FC_REFLECT( bears::protocol::claim_reward_balance_operation, (account)(reward_bears)(reward_bsd)(reward_coins) )
#ifdef BEARS_ENABLE_SMT
FC_REFLECT( bears::protocol::claim_reward_balance2_operation, (account)(extensions)(reward_tokens) )
#endif
FC_REFLECT( bears::protocol::delegate_coining_shares_operation, (delegator)(delegatee)(coining_shares) );
