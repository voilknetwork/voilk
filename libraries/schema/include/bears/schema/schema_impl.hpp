...
#define BEARS_DECLARE_SCHEMA_CLASS( is_reflected, is_enum )  \
template< typename ObjectType >                                 \
struct schema_impl< ObjectType, is_reflected, is_enum >         \
   : public abstract_schema                                     \
{                                                               \
BEARS_SCHEMA_TEMPLATE_CLASS_BODY( schema_impl )              \
};

// Templated version of macro includes some method definitions
#define BEARS_SCHEMA_TEMPLATE_CLASS_BODY( CLASSNAME )        \
...
#define BEARS_SCHEMA_CLASS_BODY( CLASSNAME )                 \
...
#define BEARS_SCHEMA_DEFINE_CLASS_METHODS( CLASSNAME )       \
...
BEARS_DECLARE_SCHEMA_CLASS( false, false )
BEARS_DECLARE_SCHEMA_CLASS(  true, false )
BEARS_DECLARE_SCHEMA_CLASS(  true,  true )
