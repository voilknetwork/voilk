...
#define VOILK_DECLARE_SCHEMA_CLASS( is_reflected, is_enum )  \
template< typename ObjectType >                                 \
struct schema_impl< ObjectType, is_reflected, is_enum >         \
   : public abstract_schema                                     \
{                                                               \
VOILK_SCHEMA_TEMPLATE_CLASS_BODY( schema_impl )              \
};

// Templated version of macro includes some method definitions
#define VOILK_SCHEMA_TEMPLATE_CLASS_BODY( CLASSNAME )        \
...
#define VOILK_SCHEMA_CLASS_BODY( CLASSNAME )                 \
...
#define VOILK_SCHEMA_DEFINE_CLASS_METHODS( CLASSNAME )       \
...
VOILK_DECLARE_SCHEMA_CLASS( false, false )
VOILK_DECLARE_SCHEMA_CLASS(  true, false )
VOILK_DECLARE_SCHEMA_CLASS(  true,  true )
