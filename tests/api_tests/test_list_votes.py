...
"""
  Usage: __name__ jobs url1 url2 [nr_cycles [working_dir [comments_file]]]
    Example: script_name 4 http://127.0.0.1:6990 http://127.0.0.1:6991 [20 my_comments_data_dir [comments]]
...
def main():
  if len( sys.argv ) < 4 or len( sys.argv ) > 7:
    ...
    print( "  Example: __name__ 4 http://127.0.0.1:6990 http://127.0.0.1:6991 [ 20 my_comments_data_dir [comments]]" )
