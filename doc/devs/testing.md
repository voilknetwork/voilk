...
operation_tests      // Unit Tests of Voilk operations
operation_time_tests // Tests of Voilk operations that include a time based component (ex. coining withdrawals)
...
```
cmake -D BUILD_VOILK_TESTNET=ON -D ENABLE_COVERAGE_TESTING=true -D CMAKE_BUILD_TYPE=Debug .
make
