...
operation_tests      // Unit Tests of Bears operations
operation_time_tests // Tests of Bears operations that include a time based component (ex. coining withdrawals)
...
```
cmake -D BUILD_BEARS_TESTNET=ON -D ENABLE_COVERAGE_TESTING=true -D CMAKE_BUILD_TYPE=Debug .
make
