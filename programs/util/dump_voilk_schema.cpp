...
using voilk::schema::abstract_schema;
...
FC_REFLECT( voilk_schema, (schema_map)(chain_object_types) )

int main( int argc, char** argv, char** envp )
{
   voilk::chain::database db;
   voilk::chain::database::open_args db_args;
   ...
   db.for_each_index_extension< voilk::chain::index_info >(
      [&]( std::shared_ptr< voilk::chain::index_info > info )
      {
         std::string name;
