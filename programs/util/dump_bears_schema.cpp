...
using bears::schema::abstract_schema;
...
FC_REFLECT( bears_schema, (schema_map)(chain_object_types) )

int main( int argc, char** argv, char** envp )
{
   bears::chain::database db;
   bears::chain::database::open_args db_args;
   ...
   db.for_each_index_extension< bears::chain::index_info >(
      [&]( std::shared_ptr< bears::chain::index_info > info )
      {
         std::string name;
